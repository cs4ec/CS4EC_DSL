...
public class ReassuranceSafetyNettingTrigger_eSignal extends ActorTypeSignal {
  public ReassuranceSafetyNettingTrigger_eSignal() {
    this.setName("ReassuranceSafetyNettingTrigger_e");
