...
public class ReassuranceSafetyNettingTrigger_cSignal extends ActorTypeSignal {
  public ReassuranceSafetyNettingTrigger_cSignal() {
    this.setName("ReassuranceSafetyNettingTrigger_c");
