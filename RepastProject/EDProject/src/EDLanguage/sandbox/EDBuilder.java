...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    try {
      ...
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 60, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 65, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 70, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 75, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 80, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 85, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 200, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 205, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 210, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 215, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 220, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 225, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 230, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 235, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 240, 90, SideRoom_lb));
      SideRoom_lb.addOccupiable(new Bed(context, space, grid, 245, 90, SideRoom_lb));
