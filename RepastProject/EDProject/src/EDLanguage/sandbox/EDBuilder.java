...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    RunEnvironment.getInstance().endAt((86400*7) / params.getInteger("SecondsPerTick"));
    ...
    Room MajorsABTwentyTwo_kb = new Room("MajorsABTwentyTwo", context, space, grid, 70, 175, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
    Room MajorsABTwentyThree_lb = new Room("MajorsABTwentyThree", context, space, grid, 70, 170, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
    Room MajorsABTwentyFour_mb = new Room("MajorsABTwentyFour", context, space, grid, 70, 165, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
    Room MajorsABTwentFive_nb = new Room("MajorsABTwentFive", context, space, grid, 70, 160, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
    Room MajorsABTwentySix_ob = new Room("MajorsABTwentySix", context, space, grid, 70, 155, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
    Room MajorsABTwentySeven_pb = new Room("MajorsABTwentySeven", context, space, grid, 70, 150, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
    Room MajorsABTwentyEight_qb = new Room("MajorsABTwentyEight", context, space, grid, 70, 145, 5, 5, 1, 5, RespiratoryBay.getInstance(), Color.RED, EmergencyDepartment_0);
