...
public class AdmittoVulnerableAreaTrigger_hSignal extends ActorTypeSignal {
  public AdmittoVulnerableAreaTrigger_hSignal() {
    this.setName("AdmittoVulnerableAreaTrigger_h");
