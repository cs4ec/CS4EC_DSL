...
public class GrammarCellsSubstituteMenu_Choice extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Choice() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cmwmou_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Choice", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cmwmou_a extends GrammarCellsSubstituteMenuPart {
    @Override
