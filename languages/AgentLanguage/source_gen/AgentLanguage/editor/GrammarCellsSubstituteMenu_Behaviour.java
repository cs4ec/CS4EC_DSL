...
public class GrammarCellsSubstituteMenu_Behaviour extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Behaviour() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_90id8w_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Behaviour", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_90id8w_a extends GrammarCellsSubstituteMenuPart {
    @Override
