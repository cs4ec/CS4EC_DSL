...
public class GrammarCellsSubstituteMenu_AgentGenerator extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AgentGenerator() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_kkf4xh_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AgentGenerator", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_kkf4xh_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AgentGenerator$SQ;
    }
  }
