...
/*package*/ class ColourLine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ColourLine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_e39due_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_e39due_a");
  ...
  public Grid createStaticHorizontal_e39due_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(2);
    if (true) {
      children.add(createTableCell_e39due_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_e39due_b0a(editorContext, node));
    }
  ...
  public Grid createTableCell_e39due_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.Colour$Y2AR;
  ...
  public Grid createTableCell_e39due_b0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.Occurances$Y34T;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private static final class PROPS {
    /*package*/ static final SProperty Colour$Y2AR = MetaAdapterFactory.getProperty(0x7dcff301ba01414eL, 0x8574a8f6da31876bL, 0xb071d920ad27f13L, 0xb071d920ad27f38L, "Colour");
    /*package*/ static final SProperty Occurances$Y34T = MetaAdapterFactory.getProperty(0x7dcff301ba01414eL, 0x8574a8f6da31876bL, 0xb071d920ad27f13L, 0xb071d920ad27f3aL, "Occurances");
  }
