...
public class GrammarCellsSubstituteMenu_RoomSelectionStrategyLine extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RoomSelectionStrategyLine() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_frpt6m_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RoomSelectionStrategyLine", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_frpt6m_a extends GrammarCellsSubstituteMenuPart {
    @Override
