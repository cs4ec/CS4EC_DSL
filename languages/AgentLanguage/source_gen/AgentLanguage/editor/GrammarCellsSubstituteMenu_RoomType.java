...
public class GrammarCellsSubstituteMenu_RoomType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RoomType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_g5fpwo_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RoomType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_g5fpwo_a extends GrammarCellsSubstituteMenuPart {
    @Override
