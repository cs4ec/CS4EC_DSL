...
public class GrammarCellsSubstituteMenu_Actor extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Actor() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e508q4_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Actor", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e508q4_a extends GrammarCellsSubstituteMenuPart {
    @Override
