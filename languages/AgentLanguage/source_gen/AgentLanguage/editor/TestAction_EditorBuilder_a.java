...
/*package*/ class TestAction_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_eha976_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new targetPatientSingleRoleHandler_eha976_b0(myNode, LINKS.targetPatient$nQFx, getEditorContext());
    return provider.createCell();
  }
  private static class targetPatientSingleRoleHandler_eha976_b0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public targetPatientSingleRoleHandler_eha976_b0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.targetPatient$nQFx, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.targetPatient$nQFx, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.targetPatient$nQFx);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.targetPatient$nQFx));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_eha976_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    ...
    provider.setNoTargetText("<no testkit>");
    EditorCell editorCell;
    editorCell = provider.createEditorCell(getEditorContext());
    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.testkit$nR9z);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_1() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_eha976_a0d0");
