...
public class GrammarCellsSubstituteMenu_BehaviourElement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BehaviourElement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_pcitzh_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BehaviourElement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_pcitzh_a extends GrammarCellsSubstituteMenuPart {
    @Override
