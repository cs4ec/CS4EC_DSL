...
/*package*/ class ProcessingTimeTable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsVertical_p3yi9b_a0(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.ProcessingTimeLines$e7T7)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$e7T7);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$e7T7)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$e7T7)).getElement(y) : null), LINKS.ProcessingTimeLines$e7T7);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$e7T7)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.ProcessingTimeLines$e7T7, editorContext);
