...
public class GrammarCellsSubstituteMenu_RoomSelectionCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RoomSelectionCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ud1tib_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RoomSelectionCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ud1tib_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.RoomSelectionCondition$N0;
    }
  }
