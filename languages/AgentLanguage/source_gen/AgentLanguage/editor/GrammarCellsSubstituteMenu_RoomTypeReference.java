...
public class GrammarCellsSubstituteMenu_RoomTypeReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RoomTypeReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cil0e5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RoomTypeReference", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cil0e5_a extends GrammarCellsSubstituteMenuPart {
    @Override
