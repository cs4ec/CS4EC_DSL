...
/*package*/ class AttributeDistributionLine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AttributeDistributionLine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_lek3gc_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_lek3gc_a");
  ...
  public Grid createStaticHorizontal_lek3gc_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(2);
    if (true) {
      children.add(createTableCell_lek3gc_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_lek3gc_b0a(editorContext, node));
    }
  ...
  public Grid createTableCell_lek3gc_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new attributeValueSingleRoleHandler_lek3gc_a0a0(myNode, LINKS.attributeValue$vq_t, getEditorContext());
    return provider.createCell();
  }
  private static class attributeValueSingleRoleHandler_lek3gc_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public attributeValueSingleRoleHandler_lek3gc_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.attributeValue$vq_t, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.attributeValue$vq_t, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.attributeValue$vq_t);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.attributeValue$vq_t));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_attributeValue");
    ...
    protected String getNoTargetText() {
      return "<no attributeValue>";
    }
  }
  public Grid createTableCell_lek3gc_b0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.probabilityDistribution$lZQn;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no probabilityDistribution>");
      editorCell.setCellId("property_probabilityDistribution");
