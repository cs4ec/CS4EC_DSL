...
public class GrammarCellsSubstituteMenu_ExpressionWrapper extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ExpressionWrapper", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lbqfmn_a extends GrammarCellsSubstituteMenuPart {
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ExpressionWrapper$uy;
    }
  }
