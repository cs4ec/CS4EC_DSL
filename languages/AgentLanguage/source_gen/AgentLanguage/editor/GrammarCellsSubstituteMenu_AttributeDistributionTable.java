...
public class GrammarCellsSubstituteMenu_AttributeDistributionTable extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AttributeDistributionTable() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_u23l1h_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_u23l1h_a extends GrammarCellsSubstituteMenuPart {
    @Override
