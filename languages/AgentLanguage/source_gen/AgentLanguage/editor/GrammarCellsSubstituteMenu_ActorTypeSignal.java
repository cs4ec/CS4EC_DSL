...
public class GrammarCellsSubstituteMenu_ActorTypeSignal extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActorTypeSignal() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_uk2i8t_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActorTypeSignal", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_uk2i8t_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActorTypeSignal$1M;
    }
  }
