...
public class GrammarCellsSubstituteMenu_BehaviourSequence extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BehaviourSequence() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fo7c3l_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BehaviourSequence", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fo7c3l_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.BehaviourSequence$Ol;
    }
  }
