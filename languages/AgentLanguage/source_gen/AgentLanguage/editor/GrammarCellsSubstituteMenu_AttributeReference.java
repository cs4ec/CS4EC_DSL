...
public class GrammarCellsSubstituteMenu_AttributeReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AttributeReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_f32mtx_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_f32mtx_a extends GrammarCellsSubstituteMenuPart {
    @Override
