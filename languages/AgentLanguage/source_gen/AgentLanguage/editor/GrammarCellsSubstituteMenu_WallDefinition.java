...
public class GrammarCellsSubstituteMenu_WallDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_WallDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_fxjnn0_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "WallDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_fxjnn0_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.WallDefinition$7h;
    }
  }
