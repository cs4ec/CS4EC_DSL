...
public class GrammarCellsSubstituteMenu_DirectSignal extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DirectSignal() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_uvxldy_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DirectSignal", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_uvxldy_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.DirectSignal$wl;
    }
  }
