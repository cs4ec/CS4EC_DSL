...
public class GrammarCellsSubstituteMenu_RoomDefinition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RoomDefinition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_qq5g0l_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RoomDefinition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_qq5g0l_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.RoomDefinition$Op;
    }
  }
