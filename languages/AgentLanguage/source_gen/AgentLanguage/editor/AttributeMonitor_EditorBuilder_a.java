...
/*package*/ class AttributeMonitor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.attribute$XrTt;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.attribute$XrTt);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.attribute$XrTt);
    }
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Possible Values:");
    editorCell.setCellId("Constant_upicif_b0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_upicif_c0");
    editorCell.addEditorCell(createRefNodeList_0());
    return editorCell;
  }
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new possibleValuesListHandler_upicif_a2a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("refNodeList_possibleValues");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class possibleValuesListHandler_upicif_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public possibleValuesListHandler_upicif_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.possibleValues$XyGU;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(possibleValuesListHandler_upicif_a2a.this.getNode(), LINKS.possibleValues$XyGU));
      try {
