...
/*package*/ class TimeDistributionTable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_6jqsiv_a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_6jqsiv_a1a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_6jqsiv_b0");
  ...
  public Grid createChildsVertical_6jqsiv_a1a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_6jqsiv_a0b0(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$5kpG)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$5kpG);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$5kpG)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$5kpG)).getElement(y) : null), LINKS.lines$5kpG);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$5kpG)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$5kpG, editorContext);
  ...
  public HeaderGrid createHeaderCollection_6jqsiv_a0b0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_6jqsiv_a0a1a(editorContext, node));
    nodeList.add(createStaticHeader_6jqsiv_b0a1a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_6jqsiv_a0a1a(final EditorContext editorContext, final SNode snode) {
  ...
  public HeaderGrid createStaticHeader_6jqsiv_b0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
