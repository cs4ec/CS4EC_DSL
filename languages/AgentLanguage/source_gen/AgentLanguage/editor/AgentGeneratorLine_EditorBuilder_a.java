...
/*package*/ class AgentGeneratorLine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AgentGeneratorLine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_an0iyd_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_an0iyd_a");
  ...
  public Grid createStaticHorizontal_an0iyd_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(1);
    if (true) {
      children.add(createTableCell_an0iyd_a0a(editorContext, node));
    }
  ...
  public Grid createTableCell_an0iyd_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.NumAgentsInHour$Puav;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no NumAgentsInHour>");
      editorCell.setCellId("property_NumAgentsInHour");
