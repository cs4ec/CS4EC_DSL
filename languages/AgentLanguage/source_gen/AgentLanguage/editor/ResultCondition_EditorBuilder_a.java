...
/*package*/ class ResultCondition_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ResultCondition_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_nfyldz_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_nfyldz_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, LINKS.test$32gZ, CONCEPTS.TestKit$6L, "test", getEditorContext()) {
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.test$32gZ);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createCollection_1() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
      editorCell.setCellId("Collection_nfyldz_a0b0");
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "gave");
    editorCell.setCellId("Constant_nfyldz_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.result$eWiA;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
