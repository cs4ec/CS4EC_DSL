...
public class GrammarCellsSubstituteMenu_DecisionTree extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DecisionTree() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_xusdaz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DecisionTree", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_xusdaz_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.DecisionTree$OB;
    }
  }
