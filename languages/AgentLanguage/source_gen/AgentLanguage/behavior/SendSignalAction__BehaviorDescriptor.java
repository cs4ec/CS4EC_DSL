...
public final class SendSignalAction__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7dcff301ba01414eL, 0x8574a8f6da31876bL, 0x3a7166f1d96f1890L, "AgentLanguage.structure.SendSignalAction");
  ...
  public static final SMethod<Boolean> IsIn_id29F2V$jt3xf = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("IsIn").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("29F2V$jt3xf").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), ""));
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept SignalInitReference$z3 = MetaAdapterFactory.getConcept(0x7dcff301ba01414eL, 0x8574a8f6da31876bL, 0x3a7166f1d96f0c93L, "AgentLanguage.structure.SignalInitReference");
  }
