...
public class Nurse extends Staff {
  ...
  public class AdmitAction_a0d extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public AdmitAction_a0d(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class AdmitAction_a0d_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public AdmitAction_a0d_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitAdmitPatient(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new AdmitAction_a0d(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);
