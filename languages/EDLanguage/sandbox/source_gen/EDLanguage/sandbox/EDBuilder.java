...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    Location MainReception_b = new Location("MainReception", context, space, grid, 55, 125, 20, 20, 1, 40, "Top", Color.GREEN);
    ...
    Location MajorsConsutltationRooms_f = new Location("MajorsConsutltationRooms", context, space, grid, 120, 50, 50, 10, 1, 50, "Top", Color.YELLOW);
    ...
    WaitingRoomLocation MajorsWaitingRoom_e = new WaitingRoomLocation("MajorsWaitingRoom", context, space, grid, 150, 60, 20, 50, 1, 50, "Left", Color.GRAY);
    WaitingRoomLocation TriageWaitingRoom_j = new WaitingRoomLocation("TriageWaitingRoom", context, space, grid, 105, 170, 50, 20, 1, 30, "Left", Color.GRAY);
