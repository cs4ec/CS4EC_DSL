...
/*package*/ class ActorInstantiation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_pl9k4a_a2a() {
    return SPropertyOperations.getInteger(myNode, PROPS.number$_2Qp) != 1;
  }
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.number$_2Qp;
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.actorType$_3kr;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.actorType$_3kr);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.actorType$_3kr);
    }
