...
/*package*/ class AttributeExpressionReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AttributeExpressionReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_2xqg8a_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.attribute$UKay;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.attribute$UKay);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.attribute$UKay);
    }
