...
/*package*/ class SignalReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public SignalReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_85lhbo_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.signal$j_fv;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.signal$j_fv);
    }
