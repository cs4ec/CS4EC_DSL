...
/*package*/ class RoomTypeReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public RoomTypeReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_z3o6pn_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_z3o6pn_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.roomType$xuJp;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.roomType$xuJp);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.roomType$xuJp);
    }
