...
public final class AddPatientAttribute_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  public AddPatientAttribute_Intention() {
    super(Kind.ERROR, false, new SNodePointer("r:0e133877-5dd0-4049-8f39-92ae11bca168(ActionCards.intentions)", "3794530329751661836"));
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SLinkOperations.setTarget(newInfectionStatus, LINKS.disease$NZ2B, SLinkOperations.getTarget(node, LINKS.disease$UB8o));
      SNode patientProperty = Sequence.fromIterable(SLinkOperations.collectMany(SModelOperations.roots(SNodeOperations.getModel(node), CONCEPTS.Patient$_D), LINKS.patientProperties$1osX)).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.isInstanceOf(it, CONCEPTS.InfectionStatusProperty$al) && Objects.equals(SLinkOperations.getTarget(((SNode) it), LINKS.disease$NZ2B), SLinkOperations.getTarget(node, LINKS.disease$UB8o));
        }
      }).first();
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      if (Sequence.fromIterable(SLinkOperations.collectMany(SModelOperations.roots(SNodeOperations.getModel(node), CONCEPTS.PatientProfile$he), LINKS.attributes$eds7)).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
          return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(it, LINKS.patientProperty$d18a), CONCEPTS.InfectionStatusProperty$al) && Objects.equals(SLinkOperations.getTarget(((SNode) SLinkOperations.getTarget(it, LINKS.patientProperty$d18a)), LINKS.disease$NZ2B), SLinkOperations.getTarget(node, LINKS.disease$UB8o));
        }
      }).isEmpty()) {
