...
public final class ActionCardElement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getFormattedName_id3ifWr0i0u$Q = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFormattedName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3ifWr0i0u$Q").build();
