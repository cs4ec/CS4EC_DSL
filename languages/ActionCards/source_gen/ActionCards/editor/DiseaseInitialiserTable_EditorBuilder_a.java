...
/*package*/ class DiseaseInitialiserTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DiseaseInitialiserTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_octiy6_a");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_octiy6_a0");
    editorCell.addEditorCell(createConstant_0());
    editorCell.addEditorCell(createRefCell_0());
    return editorCell;
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Prevalence table for");
    editorCell.setCellId("Constant_octiy6_a0a");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.Disease$k_T9;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.Disease$k_T9);
    }
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_octiy6_a1a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_octiy6_b0");
  ...
  public Grid createChildsVertical_octiy6_a1a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_octiy6_a0b0(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$gp1f)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$gp1f);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$gp1f)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$gp1f)).getElement(y) : null), LINKS.lines$gp1f);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$gp1f)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$gp1f, editorContext);
  ...
  public HeaderGrid createHeaderCollection_octiy6_a0b0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_octiy6_a0a1a(editorContext, node));
    nodeList.add(createStaticHeader_octiy6_b0a1a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_octiy6_a0a1a(final EditorContext editorContext, final SNode snode) {
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Condition", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Condition"), cell);
    header.setLabel("Condition");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_octiy6_b0a1a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
