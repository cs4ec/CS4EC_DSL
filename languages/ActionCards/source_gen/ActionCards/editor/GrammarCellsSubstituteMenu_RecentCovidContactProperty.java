...
public class GrammarCellsSubstituteMenu_RecentCovidContactProperty extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_RecentCovidContactProperty() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_cowlcz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RecentCovidContactProperty", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_cowlcz_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.RecentCovidContactProperty$IY;
    }
  }
