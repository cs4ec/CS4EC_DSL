...
/*package*/ class Action_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new outgoingBranchesListHandler_8bscln_a1a(myNode, getEditorContext());
  ...
  private static class outgoingBranchesListHandler_8bscln_a1a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public outgoingBranchesListHandler_8bscln_a1a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outgoingBranchesListHandler_8bscln_a1a.this.getNode(), LINKS.outgoingBranches$cwqF));
      try {
