...
/*package*/ class Action_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new staffTypeReferenceSingleRoleHandler_8bscln_f0(myNode, LINKS.staffTypeReference$jtXw, getEditorContext());
    return provider.createCell();
  }
  private static class staffTypeReferenceSingleRoleHandler_8bscln_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public staffTypeReferenceSingleRoleHandler_8bscln_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
