...
/*package*/ class Action_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Requires Staff Member:");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new staffTypeReferenceSingleRoleHandler_8bscln_d0(myNode, LINKS.staffTypeReference$jtXw, getEditorContext());
    return provider.createCell();
  }
  private static class staffTypeReferenceSingleRoleHandler_8bscln_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public staffTypeReferenceSingleRoleHandler_8bscln_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_8bscln_e0");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new stepsListHandler_8bscln_a4a(myNode, getEditorContext());
  ...
  private static class stepsListHandler_8bscln_a4a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public stepsListHandler_8bscln_a4a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(stepsListHandler_8bscln_a4a.this.getNode(), LINKS.steps$_zcq));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new branchSingleRoleHandler_8bscln_g0(myNode, LINKS.branch$Cp1x, getEditorContext());
    return provider.createCell();
  }
  private static class branchSingleRoleHandler_8bscln_g0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public branchSingleRoleHandler_8bscln_g0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.branch$Cp1x, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.branch$Cp1x, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.branch$Cp1x);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.branch$Cp1x));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_branch");
        installCellInfo(null, editorCell, true);
        setCellContext(editorCell);
        return editorCell;
      } finally {
