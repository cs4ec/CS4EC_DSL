...
/*package*/ class DischargeAction_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DischargeAction_diagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        editorCell.value.setCellId("DiagramNode_gt9qmo_a");
        editorCell.value.setBig(true);
        setCellContext(editorCell.value);
        Style style = new StyleImpl();
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__shade-color"), StyleRegistry.getInstance().getSimpleColor(MPSColors.lightGray));
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_gt9qmo_a0");
