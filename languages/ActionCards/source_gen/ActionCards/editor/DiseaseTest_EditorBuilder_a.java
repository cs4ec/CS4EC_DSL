...
/*package*/ class DiseaseTest_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_uol6r3_c0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new CapturedDiseasesListHandler_uol6r3_a2a(myNode, getEditorContext());
  ...
  private static class CapturedDiseasesListHandler_uol6r3_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public CapturedDiseasesListHandler_uol6r3_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(CapturedDiseasesListHandler_uol6r3_a2a.this.getNode(), LINKS.CapturedDiseases$9e0A));
      try {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ProcessingTimeTableSingleRoleHandler_uol6r3_d0(myNode, LINKS.ProcessingTimeTable$ddGw, getEditorContext());
    return provider.createCell();
  }
  private static class ProcessingTimeTableSingleRoleHandler_uol6r3_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ProcessingTimeTableSingleRoleHandler_uol6r3_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
