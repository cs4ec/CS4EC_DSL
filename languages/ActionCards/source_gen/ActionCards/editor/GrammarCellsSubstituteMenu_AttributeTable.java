...
public class GrammarCellsSubstituteMenu_AttributeTable extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AttributeTable() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bwcimv_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_bwcimv_a extends GrammarCellsSubstituteMenuPart {
    @Override
