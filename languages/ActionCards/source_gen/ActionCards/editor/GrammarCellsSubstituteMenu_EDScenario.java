...
public class GrammarCellsSubstituteMenu_EDScenario extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_EDScenario() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_e4mysl_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "EDScenario", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_e4mysl_a extends GrammarCellsSubstituteMenuPart {
    @Override
