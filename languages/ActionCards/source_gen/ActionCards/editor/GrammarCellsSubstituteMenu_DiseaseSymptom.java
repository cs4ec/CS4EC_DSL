...
public class GrammarCellsSubstituteMenu_DiseaseSymptom extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DiseaseSymptom() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_6g0zo4_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DiseaseSymptom", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_6g0zo4_a extends GrammarCellsSubstituteMenuPart {
    @Override
