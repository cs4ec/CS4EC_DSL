...
public class GrammarCellsSubstituteMenu_Conditional extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Conditional() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_4107at_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Conditional", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_4107at_a extends GrammarCellsSubstituteMenuPart {
    @Override
