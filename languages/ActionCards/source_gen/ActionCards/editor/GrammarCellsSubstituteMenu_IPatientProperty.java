...
public class GrammarCellsSubstituteMenu_IPatientProperty extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_IPatientProperty() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_b0zkxi_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IPatientProperty", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_b0zkxi_a extends GrammarCellsSubstituteMenuPart {
    @Override
