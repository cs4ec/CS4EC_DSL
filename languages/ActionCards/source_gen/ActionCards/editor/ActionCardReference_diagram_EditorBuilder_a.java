...
/*package*/ class ActionCardReference_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ActionCardReference_diagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        editorCell.value.setCellId("DiagramNode_qpjjnt_a");
        editorCell.value.setBig(true);
        setCellContext(editorCell.value);
        Style style = new StyleImpl();
        style.set(StyleAttributes.getInstance().<Color>getAttribute("de.itemis.mps.editor.diagram.styles", "__shade-color"), StyleRegistry.getInstance().getSimpleColor(MPSColors.cyan));
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_qpjjnt_a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.actionCard$QzY2;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.actionCard$QzY2);
    ...
    provider.setNoTargetText("<no actionCard>");
    EditorCell editorCell = provider.createCell();

    if (editorCell.getSRole() == null) {
      editorCell.setReferenceCell(true);
      editorCell.setSRole(LINKS.actionCard$QzY2);
    }
