...
public class GrammarCellsSubstituteMenu_AttendanceRoute extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AttendanceRoute() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_hf32g2_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AttendanceRoute", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_hf32g2_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AttendanceRoute$Nq;
    }
  }
