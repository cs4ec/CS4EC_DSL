...
/*package*/ class DiseasePrevalenceTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DiseasePrevalenceTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_a8ucb5_a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_a8ucb5_a0a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_a8ucb5_a0");
  ...
  public Grid createChildsVertical_a8ucb5_a0a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_a8ucb5_a0a0(editorContext, node));
  ...
  public HeaderGrid createHeaderCollection_a8ucb5_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_a8ucb5_a0a0a(editorContext, node));
    nodeList.add(createStaticHeader_a8ucb5_b0a0a(editorContext, node));
    nodeList.add(createStaticHeader_a8ucb5_c0a0a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_a8ucb5_a0a0a(final EditorContext editorContext, final SNode snode) {
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Disease Status", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Disease Status"), cell);
    header.setLabel("Disease Status");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_a8ucb5_b0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Vaccine Status", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Vaccine Status"), cell);
    header.setLabel("Vaccine Status");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_a8ucb5_c0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
