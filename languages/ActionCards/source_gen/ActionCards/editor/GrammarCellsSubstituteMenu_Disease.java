...
public class GrammarCellsSubstituteMenu_Disease extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Disease() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_8nrhio_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Disease", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_8nrhio_a extends GrammarCellsSubstituteMenuPart {
    @Override
