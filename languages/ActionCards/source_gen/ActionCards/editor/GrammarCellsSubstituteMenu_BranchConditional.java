...
public class GrammarCellsSubstituteMenu_BranchConditional extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_BranchConditional() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_a5bxtg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "BranchConditional", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_a5bxtg_a extends GrammarCellsSubstituteMenuPart {
    @Override
