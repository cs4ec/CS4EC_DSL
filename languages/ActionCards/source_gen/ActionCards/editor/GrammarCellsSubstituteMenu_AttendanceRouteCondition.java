...
public class GrammarCellsSubstituteMenu_AttendanceRouteCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AttendanceRouteCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_malajf_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AttendanceRouteCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_malajf_a extends GrammarCellsSubstituteMenuPart {
    @Override
