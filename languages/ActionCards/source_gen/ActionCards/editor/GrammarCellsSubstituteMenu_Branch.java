...
public class GrammarCellsSubstituteMenu_Branch extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_Branch() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_ch0den_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Branch", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_ch0den_a extends GrammarCellsSubstituteMenuPart {
    @Override
