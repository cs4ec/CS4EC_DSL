...
public class GrammarCellsSubstituteMenu_CompositeTest extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_CompositeTest() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_y3t53i_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "CompositeTest", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_y3t53i_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.CompositeTest$T8;
    }
  }
