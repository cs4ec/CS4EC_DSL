...
public class GrammarCellsSubstituteMenu_ActionDurationEmptyLine extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActionDurationEmptyLine() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_sip6m5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActionDurationEmptyLine", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_sip6m5_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActionDurationEmptyLine$Vp;
    }
  }
