...
public class GrammarCellsSubstituteMenu_PatientSeverity extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_PatientSeverity() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_zhakoz_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "PatientSeverity", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_zhakoz_a extends GrammarCellsSubstituteMenuPart {
    @Override
