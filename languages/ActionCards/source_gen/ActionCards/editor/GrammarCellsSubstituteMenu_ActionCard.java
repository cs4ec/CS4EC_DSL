...
public class GrammarCellsSubstituteMenu_ActionCard extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActionCard() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_88qjb5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActionCard", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_88qjb5_a extends GrammarCellsSubstituteMenuPart {
    @Override
