...
public class GrammarCellsSubstituteMenu_InfectionStatusCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_InfectionStatusCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_7o8ax_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "InfectionStatusCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_7o8ax_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.InfectionStatusCondition$M;
    }
  }
