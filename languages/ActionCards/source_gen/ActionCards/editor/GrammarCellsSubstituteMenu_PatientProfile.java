...
public class GrammarCellsSubstituteMenu_PatientProfile extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_PatientProfile() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_hdrwg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "PatientProfile", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_hdrwg_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.PatientProfile$ZT;
    }
  }
