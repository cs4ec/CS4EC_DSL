...
public class GrammarCellsSubstituteMenu_AttributeLine extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AttributeLine() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_bu6pvu_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AttributeLine", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_bu6pvu_a extends GrammarCellsSubstituteMenuPart {
    @Override
