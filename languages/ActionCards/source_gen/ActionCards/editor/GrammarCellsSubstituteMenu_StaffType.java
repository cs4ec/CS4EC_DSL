...
public class GrammarCellsSubstituteMenu_StaffType extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_StaffType() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_rc1x73_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "StaffType", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_rc1x73_a extends GrammarCellsSubstituteMenuPart {
    @Override
