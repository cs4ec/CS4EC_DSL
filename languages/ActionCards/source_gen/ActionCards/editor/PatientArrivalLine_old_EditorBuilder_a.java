...
/*package*/ class PatientArrivalLine_old_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PatientArrivalLine_old_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_scfqi6_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_scfqi6_a");
  ...
  public Grid createStaticHorizontal_scfqi6_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(1);
    if (true) {
      children.add(createTableCell_scfqi6_a0a(editorContext, node));
    }
  ...
  public Grid createTableCell_scfqi6_a0a(final EditorContext editorContext, final SNode node) {
    ...
    grid.setColumnHeaders(0, 0, createStaticHeader_scfqi6_a0a0(editorContext, node));
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.NumPatientsInHour_old$_nla;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no NumPatientsInHour_old>");
      editorCell.setCellId("property_NumPatientsInHour_old");
  ...
  public HeaderGrid createStaticHeader_scfqi6_a0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  private static final class PROPS {
    /*package*/ static final SProperty NumPatientsInHour_old$_nla = MetaAdapterFactory.getProperty(0xb3cac82cd02446bcL, 0xb485624ad80c3cc2L, 0x27ebd2392beaa324L, 0x27ebd2392beaa330L, "NumPatientsInHour_old");
  }
