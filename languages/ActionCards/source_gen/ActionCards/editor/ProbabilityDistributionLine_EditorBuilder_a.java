...
/*package*/ class ProbabilityDistributionLine_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_xu0alb_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_xu0alb_a");
  ...
  public Grid createStaticHorizontal_xu0alb_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(2);
    if (true) {
      children.add(createTableCell_xu0alb_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_xu0alb_b0a(editorContext, node));
    }
  ...
  public Grid createTableCell_xu0alb_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.test$Vj_e;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.test$Vj_e);
    }
  ...
  public Grid createTableCell_xu0alb_b0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.probabilityDistribution$RDTE;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
