...
/*package*/ class ObservationsCondition_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.test$Tp3g;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.test$Tp3g);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.outcome$Tawi;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
