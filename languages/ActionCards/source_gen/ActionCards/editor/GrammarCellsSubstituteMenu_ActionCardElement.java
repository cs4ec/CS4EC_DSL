...
public class GrammarCellsSubstituteMenu_ActionCardElement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActionCardElement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_tos4y5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActionCardElement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_tos4y5_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActionCardElement$yx;
    }
  }
