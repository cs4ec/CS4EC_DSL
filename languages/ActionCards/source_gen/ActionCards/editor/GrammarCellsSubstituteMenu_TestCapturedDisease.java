...
public class GrammarCellsSubstituteMenu_TestCapturedDisease extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_TestCapturedDisease() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_mlf3fc_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_mlf3fc_a extends GrammarCellsSubstituteMenuPart {
    @Override
