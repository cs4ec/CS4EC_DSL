...
/*package*/ class ResourceAvailableCondition_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ResourceAvailableCondition_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_drnft2_0");
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new availabilityExpressionSingleRoleHandler_drnft2_a0_0(myNode, LINKS.availabilityExpression$49$l, getEditorContext());
    return provider.createCell();
  }
  private static class availabilityExpressionSingleRoleHandler_drnft2_a0_0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public availabilityExpressionSingleRoleHandler_drnft2_a0_0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
