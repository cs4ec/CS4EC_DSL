...
/*package*/ class Action_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new locationSingleRoleHandler_8bscln_d0_0(myNode, LINKS.location$2x_J, getEditorContext());
    return provider.createCell();
  }
  private static class locationSingleRoleHandler_8bscln_d0_0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public locationSingleRoleHandler_8bscln_d0_0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new staffTypeReferenceSingleRoleHandler_8bscln_h0_0(myNode, LINKS.staffTypeReference$jtXw, getEditorContext());
    return provider.createCell();
  }
  private static class staffTypeReferenceSingleRoleHandler_8bscln_h0_0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public staffTypeReferenceSingleRoleHandler_8bscln_h0_0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_8bscln_5");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new outgoingBranchesListHandler_8bscln_a11a_0(myNode, getEditorContext());
  ...
  private static class outgoingBranchesListHandler_8bscln_a11a_0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public outgoingBranchesListHandler_8bscln_a11a_0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outgoingBranchesListHandler_8bscln_a11a_0.this.getNode(), LINKS.outgoingBranches$cwqF));
      try {
    ...
    private EditorCell createConstant_6() {
      ...
      editorCell.setCellId("Constant_8bscln_6");
      editorCell.setDefaultText("");
      return editorCell;
    }
  }
