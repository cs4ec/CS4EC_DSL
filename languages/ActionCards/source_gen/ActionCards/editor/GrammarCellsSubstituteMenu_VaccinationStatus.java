...
public class GrammarCellsSubstituteMenu_VaccinationStatus extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VaccinationStatus() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_yr1lkt_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VaccinationStatus", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_yr1lkt_a extends GrammarCellsSubstituteMenuPart {
    @Override
