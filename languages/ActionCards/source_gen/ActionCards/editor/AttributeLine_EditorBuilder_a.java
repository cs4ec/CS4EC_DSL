...
/*package*/ class AttributeLine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public AttributeLine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_g7hbm6_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_g7hbm6_a");
  ...
  public Grid createStaticHorizontal_g7hbm6_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(2);
    if (true) {
      children.add(createTableCell_g7hbm6_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_g7hbm6_b0a(editorContext, node));
    }
  ...
  public Grid createTableCell_g7hbm6_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new valueSingleRoleHandler_g7hbm6_a0a0(myNode, LINKS.value$QY6s, getEditorContext());
    return provider.createCell();
  }
  private static class valueSingleRoleHandler_g7hbm6_a0a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public valueSingleRoleHandler_g7hbm6_a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
