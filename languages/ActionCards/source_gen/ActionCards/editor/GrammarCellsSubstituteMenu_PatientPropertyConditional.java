...
public class GrammarCellsSubstituteMenu_PatientPropertyConditional extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_PatientPropertyConditional() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_3tacdg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "PatientPropertyConditional", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_3tacdg_a extends GrammarCellsSubstituteMenuPart {
    @Override
