...
public class GrammarCellsSubstituteMenu_ProbabilityCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ProbabilityCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_45irpd_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ProbabilityCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_45irpd_a extends GrammarCellsSubstituteMenuPart {
    @Override
