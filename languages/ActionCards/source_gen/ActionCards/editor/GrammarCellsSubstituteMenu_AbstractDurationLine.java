...
public class GrammarCellsSubstituteMenu_AbstractDurationLine extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AbstractDurationLine() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_g7n9c3_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AbstractDurationLine", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_g7n9c3_a extends GrammarCellsSubstituteMenuPart {
    @Override
