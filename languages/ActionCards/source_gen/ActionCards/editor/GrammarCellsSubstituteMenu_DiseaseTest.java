...
public class GrammarCellsSubstituteMenu_DiseaseTest extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DiseaseTest() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_lodp6x_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DiseaseTest", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lodp6x_a extends GrammarCellsSubstituteMenuPart {
    @Override
