...
/*package*/ class StaffNumber_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.staff$HYEa;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.staff$HYEa);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.number$HYc8;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
