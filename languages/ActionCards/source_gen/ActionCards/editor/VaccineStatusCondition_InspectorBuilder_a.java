...
/*package*/ class VaccineStatusCondition_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public VaccineStatusCondition_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_7ejxcs_0");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "vax status for");
    editorCell.setCellId("Constant_7ejxcs_0");
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_7ejxcs_1");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new checkValueSingleRoleHandler_7ejxcs_d0_0(myNode, LINKS.checkValue$p63D, getEditorContext());
    return provider.createCell();
  }
  private static class checkValueSingleRoleHandler_7ejxcs_d0_0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public checkValueSingleRoleHandler_7ejxcs_d0_0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
