...
public class GrammarCellsSubstituteMenu_DiseaseList extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DiseaseList() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_lob6q7_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "DiseaseList", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_lob6q7_a extends GrammarCellsSubstituteMenuPart {
    @Override
