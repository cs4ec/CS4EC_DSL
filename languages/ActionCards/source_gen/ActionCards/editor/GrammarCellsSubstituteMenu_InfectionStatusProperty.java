...
public class GrammarCellsSubstituteMenu_InfectionStatusProperty extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_InfectionStatusProperty() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_rjfgn3_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "InfectionStatusProperty", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_rjfgn3_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.InfectionStatusProperty$al;
    }
  }
