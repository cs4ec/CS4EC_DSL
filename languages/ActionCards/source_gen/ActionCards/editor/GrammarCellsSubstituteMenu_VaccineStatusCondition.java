...
public class GrammarCellsSubstituteMenu_VaccineStatusCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VaccineStatusCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_i0l3so_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VaccineStatusCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_i0l3so_a extends GrammarCellsSubstituteMenuPart {
    @Override
