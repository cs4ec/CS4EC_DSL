...
public class GrammarCellsSubstituteMenu_ObservationsCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObservationsCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_1xp4fw_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObservationsCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_1xp4fw_a extends GrammarCellsSubstituteMenuPart {
    @Override
