...
public class InfectionStatusCondition_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "InfectionStatusCondition", new SNodePointer("r:83e379e8-8e36-45eb-acaf-08cc8eb21ff8(ActionCards.editor)", "1758249876472736040")));
    try {
  ...
  public class TMP_Reference_cve8e0_a0 extends ReferenceMenuTransformationMenuPart {
    ...
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      try {
        ...
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:83e379e8-8e36-45eb-acaf-08cc8eb21ff8(ActionCards.editor)", "1758249876472736050")));
