...
public class GrammarCellsSubstituteMenu_ActionCardCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActionCardCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_6my3bw_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActionCardCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_6my3bw_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActionCardCondition$FL;
    }
  }
