...
public class GrammarCellsSubstituteMenu_ActionStep extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActionStep() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_88vu3j_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActionStep", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_88vu3j_a extends GrammarCellsSubstituteMenuPart {
    @Override
