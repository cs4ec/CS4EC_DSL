...
public class GrammarCellsSubstituteMenu_AdmissionAction extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_AdmissionAction() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_9l0yv5_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "AdmissionAction", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_9l0yv5_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.AdmissionAction$VB;
    }
  }
