...
/*package*/ class PatientArrivals_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsVertical_tlz21i_a0a(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.PatientArrivalLines$6zwB)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$6zwB);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$6zwB)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$6zwB)).getElement(y) : null), LINKS.PatientArrivalLines$6zwB);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$6zwB)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.PatientArrivalLines$6zwB, editorContext);
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ArrivalLocationSingleRoleHandler_tlz21i_c0(myNode, LINKS.ArrivalLocation$5hIS, getEditorContext());
  ...
  private static class ArrivalLocationSingleRoleHandler_tlz21i_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.ArrivalLocation$5hIS, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.ArrivalLocation$5hIS, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.ArrivalLocation$5hIS);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.ArrivalLocation$5hIS));
      try {
