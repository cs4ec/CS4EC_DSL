...
public class GrammarCellsSubstituteMenu_ConditonalStatement extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ConditonalStatement() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_qhmlq6_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ConditonalStatement", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_qhmlq6_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ConditonalStatement$kU;
    }
  }
