...
/*package*/ class PatientArrivals_old_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public PatientArrivals_old_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ewnfz6_a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_ewnfz6_a0a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_ewnfz6_a0");
  ...
  public Grid createChildsVertical_ewnfz6_a0a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setRowHeaders(0, 0, createHeaderCollection_ewnfz6_a0a0(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.PatientArrivalLines_old$6zwB)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.PatientArrivalLines_old$6zwB);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines_old$6zwB)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines_old$6zwB)).getElement(y) : null), LINKS.PatientArrivalLines_old$6zwB);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines_old$6zwB)).isEmpty()) {
      EditorCell placeholder = new EditorCellFactory(editorContext, node, grid).createPlaceholderConstant("<no PatientArrivalLines_old>");
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.PatientArrivalLines_old$6zwB, editorContext);
  ...
  public HeaderGrid createHeaderCollection_ewnfz6_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_ewnfz6_a0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_b0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_c0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_d0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_e0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_f0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_g0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_h0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_i0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_j0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_k0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_l0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_m0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_n0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_o0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_p0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_q0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_r0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_s0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_t0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_u0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_v0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_w0a0a(editorContext, node));
    nodeList.add(createStaticHeader_ewnfz6_x0a0a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, false).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_ewnfz6_a0a0a(final EditorContext editorContext, final SNode snode) {
  ...
  public HeaderGrid createStaticHeader_ewnfz6_b0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_c0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_d0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_e0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_f0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_g0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_h0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_i0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_j0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_k0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_l0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_m0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_n0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_o0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_p0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_q0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_r0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_s0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_t0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_u0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_v0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_w0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_ewnfz6_x0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Arrives at:");
    editorCell.setCellId("Constant_ewnfz6_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ArrivalLocation_oldSingleRoleHandler_ewnfz6_c0(myNode, LINKS.ArrivalLocation_old$5hIS, getEditorContext());
    return provider.createCell();
  }
  private static class ArrivalLocation_oldSingleRoleHandler_ewnfz6_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ArrivalLocation_oldSingleRoleHandler_ewnfz6_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.ArrivalLocation_old$5hIS, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.ArrivalLocation_old$5hIS, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.ArrivalLocation_old$5hIS);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.ArrivalLocation_old$5hIS));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_ArrivalLocation_old");
    ...
    protected String getNoTargetText() {
      return "<no ArrivalLocation_old>";
    }
  }

  private static final class LINKS {
    /*package*/ static final SContainmentLink PatientArrivalLines_old$6zwB = MetaAdapterFactory.getContainmentLink(0xb3cac82cd02446bcL, 0xb485624ad80c3cc2L, 0x637eade0e62ce2b8L, 0x27ebd2392beaa3d1L, "PatientArrivalLines_old");
    /*package*/ static final SContainmentLink ArrivalLocation_old$5hIS = MetaAdapterFactory.getContainmentLink(0xb3cac82cd02446bcL, 0xb485624ad80c3cc2L, 0x637eade0e62ce2b8L, 0xaabf015bf63b5d0L, "ArrivalLocation_old");
  }
}
