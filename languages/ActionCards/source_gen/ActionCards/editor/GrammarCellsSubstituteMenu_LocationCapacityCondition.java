...
public class GrammarCellsSubstituteMenu_LocationCapacityCondition extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_LocationCapacityCondition() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_x39c2g_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "LocationCapacityCondition", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_x39c2g_a extends GrammarCellsSubstituteMenuPart {
    @Override
