...
/*package*/ class DiseaseInitialiserLine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DiseaseInitialiserLine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_5lwsr0_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_5lwsr0_a");
  ...
  public Grid createStaticHorizontal_5lwsr0_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(2);
    if (true) {
      children.add(createTableCell_5lwsr0_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_5lwsr0_b0a(editorContext, node));
    }
  ...
  public Grid createTableCell_5lwsr0_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.Condition$d3Y$;
  ...
  public Grid createTableCell_5lwsr0_b0a(final EditorContext editorContext, final SNode node) {
