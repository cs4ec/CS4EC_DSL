...
public class GrammarCellsSubstituteMenu_DiseaseSymptomReference extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_DiseaseSymptomReference() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_zfnnkh_a());
    return result;
  }
  ...
  private class GrammarCellsSubstituteMenuPart_zfnnkh_a extends GrammarCellsSubstituteMenuPart {
    @Override
