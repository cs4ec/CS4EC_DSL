...
public class GrammarCellsSubstituteMenu_ObservationTest extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ObservationTest() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_tvvqjl_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ObservationTest", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_tvvqjl_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ObservationTest$BU;
    }
  }
