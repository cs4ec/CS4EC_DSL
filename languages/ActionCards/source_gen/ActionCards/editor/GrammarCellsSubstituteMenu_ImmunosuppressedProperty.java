...
public class GrammarCellsSubstituteMenu_ImmunosuppressedProperty extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ImmunosuppressedProperty() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_gs45dl_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ImmunosuppressedProperty", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_gs45dl_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ImmunosuppressedProperty$On;
    }
  }
