...
public class GrammarCellsSubstituteMenu_VaccineStatusProperty extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_VaccineStatusProperty() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_uelar4_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "VaccineStatusProperty", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_uelar4_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.VaccineStatusProperty$D4;
    }
  }
