...
public class GrammarCellsSubstituteMenu_ActionDurationMinutes extends SubstituteMenuBase {
  public GrammarCellsSubstituteMenu_ActionDurationMinutes() {
    super(true);
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new GrammarCellsSubstituteMenuPart_231lvg_a());
    return result;
  }
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ActionDurationMinutes", null));
    try {
  ...
  private class GrammarCellsSubstituteMenuPart_231lvg_a extends GrammarCellsSubstituteMenuPart {
    @Override
    ...
    public SAbstractConcept getExpectedOutputConcept() {
      return CONCEPTS.ActionDurationMinutes$_m;
    }
  }
