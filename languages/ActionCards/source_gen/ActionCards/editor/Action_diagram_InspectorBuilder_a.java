...
/*package*/ class Action_diagram_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new locationSingleRoleHandler_qie2p_d0(myNode, LINKS.location$2x_J, getEditorContext());
    return provider.createCell();
  }
  private static class locationSingleRoleHandler_qie2p_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public locationSingleRoleHandler_qie2p_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new staffTypeReferenceSingleRoleHandler_qie2p_h0(myNode, LINKS.staffTypeReference$jtXw, getEditorContext());
    return provider.createCell();
  }
  private static class staffTypeReferenceSingleRoleHandler_qie2p_h0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public staffTypeReferenceSingleRoleHandler_qie2p_h0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
      super(containmentLink, context);
      myNode = ownerNode;
    }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new outgoingBranchesListHandler_qie2p_l0(myNode, getEditorContext());
  ...
  private static class outgoingBranchesListHandler_qie2p_l0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public outgoingBranchesListHandler_qie2p_l0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(outgoingBranchesListHandler_qie2p_l0.this.getNode(), LINKS.outgoingBranches$cwqF));
      try {
