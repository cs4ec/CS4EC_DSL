...
/*package*/ class ConditionalSelection_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConditionalSelection_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_jxlvrn_a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_jxlvrn_a0a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_jxlvrn_a0");
  ...
  public Grid createChildsVertical_jxlvrn_a0a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_jxlvrn_a0a0(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$6TbH)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$6TbH);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$6TbH)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$6TbH)).getElement(y) : null), LINKS.lines$6TbH);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$6TbH)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$6TbH, editorContext);
  ...
  public HeaderGrid createHeaderCollection_jxlvrn_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_jxlvrn_a0a0a(editorContext, node));
    nodeList.add(createStaticHeader_jxlvrn_b0a0a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_jxlvrn_a0a0a(final EditorContext editorContext, final SNode snode) {
  ...
  public HeaderGrid createStaticHeader_jxlvrn_b0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
