...
/*package*/ class ProbabilityDistribution_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsVertical_67wtyh_a1a(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$V3DB);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$V3DB)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$V3DB)).getElement(y) : null), LINKS.lines$V3DB);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$V3DB)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$V3DB, editorContext);
