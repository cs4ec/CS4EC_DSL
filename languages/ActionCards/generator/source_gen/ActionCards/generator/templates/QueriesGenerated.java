...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object referenceMacro_GetReferent_1_0(final ReferenceMacroContext _context) {
    return _context.getOutputNodeByInputNodeAndMappingLabel(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.branch$Cp1x), LINKS.targetAction$Z7ub), "SignalReduction");
  }
  ...
  public static boolean ifMacro_Condition_1_0(final IfMacroContext _context) {
    return !(Objects.equals(SLinkOperations.getTarget(_context.getNode(), LINKS.branch$Cp1x), null));
  }
  public static boolean ifMacro_Condition_1_1(final IfMacroContext _context) {
    return Objects.equals(_context.getNode(), Sequence.fromIterable(SLinkOperations.collectMany(SModelOperations.roots(_context.getInputModel(), CONCEPTS.ActionCard$eb), LINKS.Actions$nh$G)).first());
  }
  ...
  {
    int i = 0;
    imcMethods.put("5402567240278564161", new IfMC(i++));
    imcMethods.put("5402567240278379168", new IfMC(i++));
  }
  @NotNull
  @Override
