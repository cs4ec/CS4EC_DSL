...
/*package*/ class StaffRoomAllocationTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public StaffRoomAllocationTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_thhmu4_a0(editorContext, node);
              ...
              editorCell.value.setCellId("Table_thhmu4_a");
  ...
  public Grid createChildsVertical_thhmu4_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_thhmu4_a0a(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$tRj8)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$tRj8);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$tRj8)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$tRj8)).getElement(y) : null), LINKS.lines$tRj8);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$tRj8)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$tRj8, editorContext);
  ...
  public HeaderGrid createHeaderCollection_thhmu4_a0a(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_thhmu4_a0a0(editorContext, node));
    nodeList.add(createStaticHeader_thhmu4_b0a0(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_thhmu4_a0a0(final EditorContext editorContext, final SNode snode) {
  ...
  public HeaderGrid createStaticHeader_thhmu4_b0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Limit", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Limit"), cell);
    header.setLabel("Limit");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
