...
/*package*/ class Room_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Room_diagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        editorCell.value.setCellId("DiagramNode_nbkxem_a");
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_nbkxem_a0");
