...
/*package*/ class ConditionalSelection_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsVertical_jxlvrn_a0a(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$tWeI)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$tWeI);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$tWeI)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$tWeI)).getElement(y) : null), LINKS.lines$tWeI);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$tWeI)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$tWeI, editorContext);
