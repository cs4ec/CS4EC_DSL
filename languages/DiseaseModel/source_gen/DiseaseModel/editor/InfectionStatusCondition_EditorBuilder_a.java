...
/*package*/ class InfectionStatusCondition_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public InfectionStatusCondition_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ii6agb_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "infection status for");
    editorCell.setCellId("Constant_ii6agb_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.patientProperty$FJ4E;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        ...
        }, targetNode, LINKS.patientProperty$FJ4E);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.patientProperty$FJ4E);
    }
    editorCell.setTransformationMenuLookup(new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InfectionStatusCondition$3N));
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ii6agb_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new checkValueSingleRoleHandler_ii6agb_d0(myNode, LINKS.checkValue$p63D, getEditorContext());
    return provider.createCell();
  }
  private static class checkValueSingleRoleHandler_ii6agb_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public checkValueSingleRoleHandler_ii6agb_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept InfectionStatusCondition$3N = MetaAdapterFactory.getConcept(0xbb69d08796cc48caL, 0xaeb6c2cb27e532b0L, 0x18668ef27101e2faL, "DiseaseModel.structure.InfectionStatusCondition");
