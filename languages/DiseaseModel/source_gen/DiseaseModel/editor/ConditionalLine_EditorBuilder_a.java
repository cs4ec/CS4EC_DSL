...
/*package*/ class ConditionalLine_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ConditionalLine_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private jetbrains.mps.nodeEditor.cells.EditorCell createPartialTable_0(final EditorContext editorContext, final SNode node) {
    ...
    try {
      ...
      final Grid grid = createStaticHorizontal_2dzpx5_a0(editorContext, node);
      ...
      editorCell.setCellId("PartialTable_2dzpx5_a");
  ...
  public Grid createStaticHorizontal_2dzpx5_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();

    List<Grid> children = new ArrayList<Grid>(2);
    if (true) {
      children.add(createTableCell_2dzpx5_a0a(editorContext, node));
    }
    if (true) {
      children.add(createTableCell_2dzpx5_b0a(editorContext, node));
    }
  ...
  public Grid createTableCell_2dzpx5_a0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.test$tHUi;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.test$tHUi);
    }
  ...
  public Grid createTableCell_2dzpx5_b0a(final EditorContext editorContext, final SNode node) {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conditionSingleRoleHandler_2dzpx5_a1a0(myNode, LINKS.condition$tHsg, getEditorContext());
    return provider.createCell();
  }
  private static class conditionSingleRoleHandler_2dzpx5_a1a0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public conditionSingleRoleHandler_2dzpx5_a1a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.condition$tHsg, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.condition$tHsg, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.condition$tHsg);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.condition$tHsg));
      try {
