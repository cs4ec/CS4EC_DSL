...
/*package*/ class InfectionSpreadTable_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public InfectionSpreadTable_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_mddns2_a0(editorContext, node);
              ...
              editorCell.value.setCellId("Table_mddns2_a");
  ...
  public Grid createChildsVertical_mddns2_a0(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_mddns2_a0a(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$F2yI)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$F2yI);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$F2yI)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$F2yI)).getElement(y) : null), LINKS.lines$F2yI);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$F2yI)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$F2yI, editorContext);
  ...
  public HeaderGrid createHeaderCollection_mddns2_a0a(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_mddns2_a0a0(editorContext, node));
    nodeList.add(createStaticHeader_mddns2_b0a0(editorContext, node));
    nodeList.add(createStaticHeader_mddns2_c0a0(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_mddns2_a0a0(final EditorContext editorContext, final SNode snode) {
    ...
    final EditorCell_Constant cell = new EditorCell_Constant(editorContext, snode, "Infection Status", false);
    Header header = new EditorCellHeader(new StringHeaderReference("Infection Status"), cell);
    header.setLabel("Infection Status");
    header.setStyle(style);
    HeaderGrid grid = new HeaderGrid();
    grid.setElement(0, 0, header);
    return grid;
  }
  public HeaderGrid createStaticHeader_mddns2_b0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
  ...
  public HeaderGrid createStaticHeader_mddns2_c0a0(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
