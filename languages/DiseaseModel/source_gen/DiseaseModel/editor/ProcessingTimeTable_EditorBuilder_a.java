...
/*package*/ class ProcessingTimeTable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_p3yi9b_a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_p3yi9b_a0a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_p3yi9b_a0");
  ...
  public Grid createChildsVertical_p3yi9b_a0a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);

    grid.setColumnHeaders(0, 0, createHeaderCollection_p3yi9b_a0a0(editorContext, node));

    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.ProcessingTimeLines$l46N)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$l46N);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$l46N)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$l46N)).getElement(y) : null), LINKS.ProcessingTimeLines$l46N);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.ProcessingTimeLines$l46N)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.ProcessingTimeLines$l46N, editorContext);
  ...
  public HeaderGrid createHeaderCollection_p3yi9b_a0a0(final EditorContext editorContext, final SNode node) {
    ...
    nodeList.add(createStaticHeader_p3yi9b_a0a0a(editorContext, node));
    nodeList.add(createStaticHeader_p3yi9b_b0a0a(editorContext, node));

    return new HeaderGridFactory(editorContext, node, true).createFromHeaderGridList(nodeList);
  }
  public HeaderGrid createStaticHeader_p3yi9b_a0a0a(final EditorContext editorContext, final SNode snode) {
  ...
  public HeaderGrid createStaticHeader_p3yi9b_b0a0a(final EditorContext editorContext, final SNode snode) {
    final Style style = new ITableStyleFactory() {
      public Style createStyle(final int columnIndex, final int rowIndex) {
        Style style = new StyleImpl();
        final EditorCell editorCell = null;
