...
/*package*/ class VaccineStatusCondition_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public VaccineStatusCondition_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_7ejxcs_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "vaccine status for");
    editorCell.setCellId("Constant_7ejxcs_a0");
  ...
  private EditorCell createRefCell_0() {
    ...
    editorCell.setTransformationMenuLookup(new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.VaccineStatusCondition$fr));
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_7ejxcs_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new checkValueSingleRoleHandler_7ejxcs_d0(myNode, LINKS.checkValue$p63D, getEditorContext());
    return provider.createCell();
  }
  private static class checkValueSingleRoleHandler_7ejxcs_d0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public checkValueSingleRoleHandler_7ejxcs_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
