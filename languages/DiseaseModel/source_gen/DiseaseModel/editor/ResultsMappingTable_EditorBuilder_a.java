...
/*package*/ class ResultsMappingTable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsVertical_noxl7v_a0a(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.lines$CQoa)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.lines$CQoa);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$CQoa)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$CQoa)).getElement(y) : null), LINKS.lines$CQoa);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$CQoa)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.lines$CQoa, editorContext);
