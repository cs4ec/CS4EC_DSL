...
public class InfectionStatusCondition_TransformationMenu extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default transformation menu for " + "InfectionStatusCondition", new SNodePointer("r:0a859d27-3611-4be0-a1c1-43c12a234eaa(DiseaseModel.editor)", "1758249876472736040")));
    try {
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new TMP_Reference_cve8e0_a0());
    }
    return result;
  }

  public class TMP_Reference_cve8e0_a0 extends ReferenceMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      try {
        ...
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:0a859d27-3611-4be0-a1c1-43c12a234eaa(DiseaseModel.editor)", "1758249876472736050")));
    ...
    private class Item extends ReferenceTransformationMenuItem implements SubstituteCompletionActionItem {
      ...
      public String getLabelText(String pattern) {
        return SPropertyOperations.getString(SLinkOperations.getTarget(((SNode) targetNode), LINKS.disease$NZ2B), PROPS.name$MnvL);
      }
