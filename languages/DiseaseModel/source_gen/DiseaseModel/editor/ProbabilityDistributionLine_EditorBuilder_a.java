...
/*package*/ class ProbabilityDistributionLine_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.test$imCf;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.test$imCf);
    }
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.probability$eGWF;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
