...
/*package*/ class ObservationsCondition_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ObservationsCondition_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ad62sc_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ad62sc_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.test$gs6h;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.test$gs6h);
    }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_ad62sc_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.outcome$gdzj;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
