...
public final class AddSubProcess_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  public AddSubProcess_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:fa7a70e7-4bfa-49c3-ba94-93d463233bd8(DiseaseModel.intentions)", "5730579165026210361"));
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      if (Objects.equals(SLinkOperations.getTarget(node, LINKS.TestingProcess$CLjr), null)) {
      }
    }
