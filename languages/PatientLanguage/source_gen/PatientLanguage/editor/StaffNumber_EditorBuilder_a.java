...
/*package*/ class StaffNumber_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public StaffNumber_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_ibo9bl_a");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.staff$BTVv;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.staff$BTVv);
    }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_ibo9bl_b0");
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.number$BTtt;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
