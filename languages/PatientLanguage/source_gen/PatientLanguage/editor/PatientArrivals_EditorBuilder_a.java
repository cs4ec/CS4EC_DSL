...
/*package*/ class PatientArrivals_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public Grid createChildsVertical_tlz21i_a0a(final EditorContext editorContext, final SNode node) {
    ...
    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.PatientArrivalLines$uLW)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$uLW);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$uLW)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$uLW)).getElement(y) : null), LINKS.PatientArrivalLines$uLW);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.PatientArrivalLines$uLW)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.PatientArrivalLines$uLW, editorContext);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_tlz21i_b0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new ArrivalLocationSingleRoleHandler_tlz21i_c0(myNode, LINKS.ArrivalLocation$Zd0d, getEditorContext());
    return provider.createCell();
  }
  private static class ArrivalLocationSingleRoleHandler_tlz21i_c0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public ArrivalLocationSingleRoleHandler_tlz21i_c0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.ArrivalLocation$Zd0d, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.ArrivalLocation$Zd0d, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.ArrivalLocation$Zd0d);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.ArrivalLocation$Zd0d));
      try {
        EditorCell editorCell = super.createEmptyCell();
        editorCell.setCellId("empty_ArrivalLocation");
