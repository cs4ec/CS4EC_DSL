...
public class CubicleNurse extends Actor {
  ...
  public class SendSignalAction_a0h0b extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new AdmitAmberTrigger_jSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_a0d0e_0 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0d0e_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_d0e_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_d0e_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).Immunocompromised == "Yes") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0d0e_0(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class Choice_a0i extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).LateralFlowTestCOVIDResult == "Positive" || ((patient) behaviour.getSignalTrigger().GetData("patient")).POCTTestCOVIDResult == "Positive") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class Choice_a0j extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).POCTTestFluResult == "Positive") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitIspatientbeingadmittedtovulnerablearea_f(Signal s) {
    ...
    plstSteps.add(new Choice_d0e_0(behaviourBuilder));
