...
public class CubicleNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "PerformLIATorCepheidTrigger_b":
        behaviourBuilder = new Behaviour("PerformLIATorCepheidTrigger_b", this);
        this.InitPerformLIATorCepheid_a(s);
        break;
      case "ActionTwoTrigger_b":
        behaviourBuilder = new Behaviour("ActionTwoTrigger_b", this);
        this.InitActionTwo_b(s);
        break;
  ...
  public class SendSignalAction_e0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new ActionTwoTrigger_bSignal();
  ...
  public class SendSignalAction_a0a0d extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new PerformLIATorCepheidTrigger_bSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public void InitPerformLIATorCepheid_a(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitActionTwo_b(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
