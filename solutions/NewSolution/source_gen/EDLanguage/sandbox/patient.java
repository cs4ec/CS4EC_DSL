...
public class patient extends Actor {
  ...
  public String nullInfectionStatus = "NotConfigured";
  ...
  public int getnullInfectionStatusisSusceptible() {
    if (this.nullInfectionStatus == "Susceptible") {
      return 1;
    }
    return 0;
  }
  ...
  public class Consequence_a0a0a0a extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).nullInfectionStatus = "Exposed";
  ...
  public class Choice_a0a0a_1 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("InfectionSpreadChance:(instance of Asymptomatic)-10_a0"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class Choice_a0a_3 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).admittedTo == "NA" && ((patient) behaviour.getSignalTrigger().GetData("patient")).nullInfectionStatus == "Asymptomatic" && distanceTo(((patient) behaviour.getSignalTrigger().GetData("patient"))) < 10) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void ScheduledBehaviourFornull() {
    for (Object object : context.getObjects(patient.class)) {
      patient a = (patient) object;
      if (a.deSpawnTime == 0) {
        Signal s = new Signal();
        s.setName("patient" + a.agentName());
        s.setDescription("BackgroundBehaviourFornullTrigger");
        s.AddActor("patient");
        s.AddData("patient", a);
        BackgroundBehaviourFornull(s);
      }
    }
  }
  public void BackgroundBehaviourFornull(Signal s) {
    BackgroundBehaviour backgroundBehaviour = new BackgroundBehaviour("BackgroundBehaviourFornull", this);
