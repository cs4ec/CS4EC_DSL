...
public class TriagingToolExecutionTimeMap {
  protected Distribution<Integer> processingTimeDistribution;
  protected static TriagingToolExecutionTimeMap instance;

  private TriagingToolExecutionTimeMap() {
  ...
  public static TriagingToolExecutionTimeMap getInstance() {
    if (instance == null) {
      instance = new TriagingToolExecutionTimeMap();
    }
    return instance;
  }
