...
public class AdditionalAssessmentTrigger_gSignal extends ActorTypeSignal {
  public AdditionalAssessmentTrigger_gSignal() {
    this.setName("AdditionalAssessmentTrigger_g");
