...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    Area EmergencyDepartment_0 = new Area(context, space, grid, 1, 1, 62, 200, Color.WHITE);
    ...
    EmergencyDepartment_0.addResource(RapidPCRTest.getInstance(), 1000);
    EmergencyDepartment_0.setReplenishAmount(LabPCR.getInstance(), 200);
    EmergencyDepartment_0.setReplenishAmount(LateralFlowTest.getInstance(), 500);
    EmergencyDepartment_0.setReplenishAmount(RapidPCRTest.getInstance(), 1000);
    EmergencyDepartment_0.setReplenishFrequency(LabPCR.getInstance(), 7);
    EmergencyDepartment_0.setReplenishFrequency(LateralFlowTest.getInstance(), 7);
    EmergencyDepartment_0.setReplenishFrequency(RapidPCRTest.getInstance(), 1);
    ...
    Room MajorsABOne_h = new Room("MajorsABOne", context, space, grid, 35, 195, 5, 5, 1, 5, MajorsAB_Cubicle.getInstance(), Color.GREEN, EmergencyDepartment_0);
    Room MajorsABTwo_i = new Room("MajorsABTwo", context, space, grid, 40, 195, 5, 5, 1, 5, MajorsAB_Cubicle.getInstance(), Color.GREEN, EmergencyDepartment_0);
    Room MajorsABThree_j = new Room("MajorsABThree", context, space, grid, 45, 195, 5, 5, 1, 5, MajorsAB_Cubicle.getInstance(), Color.GREEN, EmergencyDepartment_0);
    Room COVIDCohort_k = new Room("COVIDCohort", context, space, grid, 40, 165, 10, 10, 1, 10000, COVIDPositiveCohort.getInstance(), Color.RED, EmergencyDepartment_0);
    Room GreenBay_l = new Room("GreenBay", context, space, grid, 52, 165, 10, 10, 1, 100000, GreenBay.getInstance(), Color.GREEN, EmergencyDepartment_0);
    Room SideRoom_m = new Room("SideRoom", context, space, grid, 52, 153, 10, 10, 1, 10000000, SideRoom.getInstance(), Color.GRAY, EmergencyDepartment_0);
    ...
    try {
      ...
      MajorsABOne_h.addOccupiable(new Bed(context, space, grid, 36, 196, MajorsABOne_h));
      MajorsABTwo_i.addOccupiable(new Bed(context, space, grid, 41, 196, MajorsABTwo_i));
      MajorsABThree_j.addOccupiable(new Bed(context, space, grid, 46, 196, MajorsABThree_j));
  ...
  public void CreatePatientArrivalMap() {
    ...
    ArrivalPerHour.putIfAbsent(1, 3);
    ...
    ArrivalPerHour.putIfAbsent(9, 9);
    ArrivalPerHour.putIfAbsent(10, 10);
    ArrivalPerHour.putIfAbsent(11, 13);
    ArrivalPerHour.putIfAbsent(12, 12);
    ArrivalPerHour.putIfAbsent(13, 14);
    ArrivalPerHour.putIfAbsent(14, 16);
    ArrivalPerHour.putIfAbsent(15, 13);
    ArrivalPerHour.putIfAbsent(16, 15);
    ArrivalPerHour.putIfAbsent(17, 17);
    ArrivalPerHour.putIfAbsent(18, 13);
    ArrivalPerHour.putIfAbsent(19, 10);
    ArrivalPerHour.putIfAbsent(20, 9);
    ArrivalPerHour.putIfAbsent(21, 7);
    ArrivalPerHour.putIfAbsent(22, 7);
    ArrivalPerHour.putIfAbsent(23, 6);
