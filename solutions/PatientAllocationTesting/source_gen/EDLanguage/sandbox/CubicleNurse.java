...
public class CubicleNurse extends Actor {
  ...
  public class Choice_a0g0e extends InstantBehaviourStep {
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("RapidPCRTestCOVIDSensitivity"))) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0g0e_0(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  ...
  public class Choice_a0g0e_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0g0e_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("RapidPCRTestCOVIDSpecificity"))) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0g0e_2(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Choice_g0e extends InstantBehaviourStep {
    ...
    public void execute() {
      if ((((patient) behaviour.getSignalTrigger().GetData("patient")).COVIDInfectionStatus == "Symptomatic") || (((patient) behaviour.getSignalTrigger().GetData("patient")).COVIDInfectionStatus == "Asymptomatic")) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0g0e_0(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
