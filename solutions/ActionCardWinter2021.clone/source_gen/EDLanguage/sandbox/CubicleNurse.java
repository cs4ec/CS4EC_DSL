...
public class CubicleNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    switch (s.getName()) {
      ...
      case "NewpatientArrive":
        ...
        break;
      case "LIATTrigger_b0":
        behaviourBuilder = new Behaviour("LIATTrigger_b0");
        this.InitLIAT_d(s);
        break;
      default:
  ...
  public class StayAction_d0a extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = LFT.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class Choice_f0a extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).LFTResult == "Positive") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class Choice_g0a extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).LFTResult == "Negative") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class Consequence_a0a0e0a extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).LFTResult = "Positive";
  ...
  public class Consequence_a0a0e0a_1 extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).LFTResult = "Negative";
  ...
  public class SendSignalAction_a0f0a extends BehaviourStep {
    ...
    public void execute() {
      ...
      sendSignalTemp = new PCRTrigger_a0Signal();
  ...
  public class SendSignalAction_a0g0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new LIATTrigger_b0Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_a0h0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new PCRTrigger_c0Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class Choice_d0b extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).COVID == "Symptomatic") {
        ...
        plstSteps.add(new Choice_b0d0b(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class SendSignalAction_e0b extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new AdmittosideroomTrigger_a3Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class Choice_a0d0b_3 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).COVID == "Asymptomatic") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0a0d0b_3(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class Choice_b0d0b extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_b0d0b(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(99)) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0b0d0b(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0b0d0b_1(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  ...
  public class Choice_a0a0d0b_3 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0a0d0b_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(98)) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0a0d0b(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0a0d0b_1(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Choice_a0a0d0b_5 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0a0d0b_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0a0d0b extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0a0d0b(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0a0d0b_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0a0d0b_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0a0d0b_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0a0d0b_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0a0d0b_2 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0a0d0b_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_b0d0b_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_b0d0b_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0b0d0b extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0b0d0b(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0b0d0b_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0b0d0b_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0b0d0b_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0b0d0b_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0b0d0b_2 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0b0d0b_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
