...
public class CubicleNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "ActionOneTrigger_b":
        behaviourBuilder = new Behaviour("ActionOneTrigger_b", this);
        this.InitActionOne_a(s);
        break;
      case "ActionTwowithTestTrigger_b":
        behaviourBuilder = new Behaviour("ActionTwowithTestTrigger_b", this);
        this.InitActionTwowithTest_b(s);
        break;
      case "ActionThreeTrigger_c":
        behaviourBuilder = new Behaviour("ActionThreeTrigger_c", this);
        this.InitActionThree_c(s);
        break;
  ...
  public class SendSignalAction_e0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new ActionTwowithTestTrigger_bSignal();
  ...
  public class UseAction_e0b extends InstantBehaviourStep {
    ...
    public void execute() {
      ...
      ((Room) ToolBox().ReadMap().getCurrentRoom(CubicleNurse.this)).getParentArea().decrementResource(Test.getInstance());
    }
  }
  public class StayAction_f0b extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TestExecutionTimeMap.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class Consequence_a0a0g0b extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).TestCOVIDResult = "Positive";
  ...
  public class Consequence_a0a0g0b_0 extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).TestCOVIDResult = "Negative";
  ...
  public class Choice_a0g0b extends InstantBehaviourStep {
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("TestCOVIDSensitivity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class Choice_a0g0b_0 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("TestCOVIDSpecificity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class SendSignalAction_h0b extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new ActionThreeTrigger_cSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_a0a0d extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new ActionOneTrigger_bSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public void InitActionOne_a(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitActionTwowithTest_b(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitActionThree_c(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
