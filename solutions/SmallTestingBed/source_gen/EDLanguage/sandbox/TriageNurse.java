...
public class TriageNurse extends Actor {
  ...
  public class Choice_k0a extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).PHEThreeFluAResult == "Positive" || ((patient) behaviour.getSignalTrigger().GetData("patient")).PHEThreeFluBResult == "Positive" || ((patient) behaviour.getSignalTrigger().GetData("patient")).PHEThreeCOVIDResult == "Positive") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class SendSignalAction_a0l0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new DoctorAssessmentTrigger_iSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class Choice_l0a extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).PHEThreeFluAResult == "Negative" || ((patient) behaviour.getSignalTrigger().GetData("patient")).PHEThreeFluBResult == "Negative" || ((patient) behaviour.getSignalTrigger().GetData("patient")).PHEThreeCOVIDResult == "Negative") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class SendSignalAction_a0a0a1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0a0a1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class ProbabilityDistribution_a0b extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public ProbabilityDistribution_a0b(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      ...
      if (rndDouble < ((100) / 100)) {

        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0a0a1(behaviour));
        behaviour.injectSteps(plstSteps);
  ...
  public void InitPatientArrives_k(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new ProbabilityDistribution_a0b(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);
