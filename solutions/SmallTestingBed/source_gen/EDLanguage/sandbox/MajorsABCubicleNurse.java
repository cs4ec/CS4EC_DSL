...
public class MajorsABCubicleNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      ...
      case "IspatientbeingadmittedtovulnerableareaTrigger_e":
        ...
        break;
      case "NurseTreatmentsTrigger_h":
        behaviourBuilder = new Behaviour("NurseTreatmentsTrigger_h", this);
        this.InitNurseTreatments_h(s);
        break;
      case "NurseTreatmentsTrigger_j":
        behaviourBuilder = new Behaviour("NurseTreatmentsTrigger_j", this);
        this.InitNurseTreatments_j(s);
        break;
      default:
  ...
  public class SendSignalAction_j0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new DoctorAssessmentTrigger_gSignal();
  ...
  public class SendSignalAction_j0c extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_j0c(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_e0d_0 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_e0d_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitIspatientbeingadmittedtovulnerablearea_e(Signal s) {
    ...
    plstSteps.add(new SendSignalAction_j0c(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitNurseTreatments_h(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    ...
    plstSteps.add(new SendSignalAction_e0d_0(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitNurseTreatments_j(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
