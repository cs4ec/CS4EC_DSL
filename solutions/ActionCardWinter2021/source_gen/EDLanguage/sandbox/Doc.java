...
public class Doc extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    switch (s.getName()) {
      case "":
        break;
      case "AdmittoCOVIDbayTrigger":
        behaviourBuilder = new Behaviour("AdmittoCOVIDbayTrigger");
        this.InitAdmitActionAdmittoCOVIDbay(s);
        break;
      case "AdmittoFluBayTrigger":
        behaviourBuilder = new Behaviour("AdmittoFluBayTrigger");
        this.InitAdmitActionAdmittoFluBay(s);
        break;
      case "AdmittononrespiratoryTrigger":
        behaviourBuilder = new Behaviour("AdmittononrespiratoryTrigger");
        this.InitAdmitActionAdmittononrespiratory(s);
        break;
      case "AdmittosideroomTrigger":
        behaviourBuilder = new Behaviour("AdmittosideroomTrigger");
        this.InitAdmitActionAdmittosideroom(s);
        break;
      default:
  ...
  public class RemoveRelationshipAction_b0a extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_b0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_b0a_0 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_b0a_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_b0b extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_b0b(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_b0b_0 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_b0b_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitAdmitActionAdmittoCOVIDbay(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0a(behaviourBuilder));
    plstSteps.add(new RemoveRelationshipAction_b0a(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitAdmitActionAdmittoFluBay(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0b(behaviourBuilder));
    plstSteps.add(new RemoveRelationshipAction_b0b(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitAdmitActionAdmittononrespiratory(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitAdmitActionAdmittosideroom(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
