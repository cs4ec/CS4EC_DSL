...
public class DoctorAssessmentTrigger_k_0Signal extends ActorTypeSignal {
  public DoctorAssessmentTrigger_k_0Signal() {
    this.setName("DoctorAssessmentTrigger_k_0");
