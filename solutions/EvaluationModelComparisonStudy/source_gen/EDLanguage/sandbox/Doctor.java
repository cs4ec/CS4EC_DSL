...
public class Doctor extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      ...
      case "AdmittoVulnerableAreaTrigger_g":
        ...
        this.InitAdmitActionAdmittoVulnerableArea_g(s);
        break;
      case "NoFurtherTestingTrigger_h":
  ...
  public class UseAction_a0c0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public UseAction_a0c0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }

    public void execute() {

      ((Room) ToolBox().ReadMap().getCurrentRoom(Doctor.this)).getParentArea().decrementResource(LFT.getInstance());
    }
  }
  public class StayAction_b0c0a extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = LFTExecutionTimeMap.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
    public StayAction_b0c0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0c0c0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0c0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0c0c0a_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0c0a_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_a0c0c0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0c0c0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("LFTCOVIDSensitivity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0c0a(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0c0a_0(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Consequence_a0a0c0c0a_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0c0a_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0c0c0a_2 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0c0a_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_a0c0c0a_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0c0c0a_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("LFTCOVIDSpecificity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0c0a_1(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0c0a_2(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Choice_c0c0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_c0c0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if ((((patient) behaviour.getSignalTrigger().GetData("patient")).COVIDInfectionStatus == "Symptomatic") || (((patient) behaviour.getSignalTrigger().GetData("patient")).COVIDInfectionStatus == "Asymptomatic")) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0c0c0a(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0c0c0a_0(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Consequence_d0c0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_d0c0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }

    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).LFTorPCRCOVIDResult = ((patient) behaviour.getSignalTrigger().GetData("patient")).LFTCOVIDResult;
  ...
  public class Choice_c0a extends InstantBehaviourStep {
    ...
    public void execute() {
      if (true) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new UseAction_a0c0a(behaviour));
        plstSteps.add(new StayAction_b0c0a(behaviour));
        plstSteps.add(new Choice_c0c0a(behaviour));
        plstSteps.add(new Consequence_d0c0a(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class UseAction_a0d0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public UseAction_a0d0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }

    public void execute() {

      ((Room) ToolBox().ReadMap().getCurrentRoom(Doctor.this)).getParentArea().decrementResource(LabPCR.getInstance());
    }
  }
  public class StayAction_b0d0a extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = LabPCRExecutionTimeMap.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
    public StayAction_b0d0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0c0d0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0d0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0c0d0a_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0d0a_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_a0c0d0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0c0d0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("LabPCRCOVIDSensitivity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0d0a(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0d0a_0(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Consequence_a0a0c0d0a_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0d0a_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0c0d0a_2 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0c0d0a_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_a0c0d0a_0 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0c0d0a_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("LabPCRCOVIDSpecificity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0d0a_1(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0c0d0a_2(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Choice_c0d0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_c0d0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if ((((patient) behaviour.getSignalTrigger().GetData("patient")).COVIDInfectionStatus == "Symptomatic") || (((patient) behaviour.getSignalTrigger().GetData("patient")).COVIDInfectionStatus == "Asymptomatic")) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0c0d0a(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0c0d0a_0(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Consequence_d0d0a extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_d0d0a(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_d0a extends InstantBehaviourStep {
    ...
    public void execute() {
      if (false) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new UseAction_a0d0a(behaviour));
        plstSteps.add(new StayAction_b0d0a(behaviour));
        plstSteps.add(new Choice_c0d0a(behaviour));
        plstSteps.add(new Consequence_d0d0a(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class MoveAction_b0c extends BehaviourStep {
    ...
    public MoveAction_b0c(Behaviour behaviour) {
      target = VulnerableArea.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_e0c extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).admittedTo = "VulnerableArea";
  ...
  public void InitAdmitActionAdmittoVulnerableArea_g(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitDischargeActionNoFurtherTesting_h(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
