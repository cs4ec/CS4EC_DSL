...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    EmergencyDepartment_0.addResource(LFT.getInstance(), 1000);
    ...
    EmergencyDepartment_0.setReplenishAmount(LFT.getInstance(), 500);
    ...
    EmergencyDepartment_0.setReplenishFrequency(LFT.getInstance(), 7);
    ...
    Room GreenBay_fb = new Room("GreenBay", context, space, grid, 52, 165, 10, 10, 1, 100000, GreenBay.getInstance(), Color.GREEN, EmergencyDepartment_0);
    Room SideRoom_gb = new Room("SideRoom", context, space, grid, 52, 153, 10, 10, 1, 10000000, SideRoom.getInstance(), Color.GRAY, EmergencyDepartment_0);
