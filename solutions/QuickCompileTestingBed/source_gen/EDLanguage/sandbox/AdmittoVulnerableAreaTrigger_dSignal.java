...
public class AdmittoVulnerableAreaTrigger_dSignal extends ActorTypeSignal {
  public AdmittoVulnerableAreaTrigger_dSignal() {
    this.setName("AdmittoVulnerableAreaTrigger_d");
