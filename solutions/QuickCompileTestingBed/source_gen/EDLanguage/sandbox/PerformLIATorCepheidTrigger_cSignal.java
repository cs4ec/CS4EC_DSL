...
public class PerformLIATorCepheidTrigger_cSignal extends ActorTypeSignal {
  public PerformLIATorCepheidTrigger_cSignal() {
    this.setName("PerformLIATorCepheidTrigger_c");
