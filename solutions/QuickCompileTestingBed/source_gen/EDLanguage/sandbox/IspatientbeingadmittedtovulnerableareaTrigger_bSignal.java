...
public class IspatientbeingadmittedtovulnerableareaTrigger_bSignal extends ActorTypeSignal {
  public IspatientbeingadmittedtovulnerableareaTrigger_bSignal() {
    this.setName("IspatientbeingadmittedtovulnerableareaTrigger_b");
