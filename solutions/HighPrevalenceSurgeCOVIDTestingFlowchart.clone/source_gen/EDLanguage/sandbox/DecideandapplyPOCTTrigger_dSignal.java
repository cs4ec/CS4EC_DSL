...
public class DecideandapplyPOCTTrigger_dSignal extends ActorTypeSignal {
  public DecideandapplyPOCTTrigger_dSignal() {
    this.setName("DecideandapplyPOCTTrigger_d");
