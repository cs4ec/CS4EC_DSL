...
public class CheckClinicalSuspicionTrigger_hSignal extends ActorTypeSignal {
  public CheckClinicalSuspicionTrigger_hSignal() {
    this.setName("CheckClinicalSuspicionTrigger_h");
