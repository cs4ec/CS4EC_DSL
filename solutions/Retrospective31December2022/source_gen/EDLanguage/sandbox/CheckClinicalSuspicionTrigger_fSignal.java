...
public class CheckClinicalSuspicionTrigger_fSignal extends ActorTypeSignal {
  public CheckClinicalSuspicionTrigger_fSignal() {
    this.setName("CheckClinicalSuspicionTrigger_f");
