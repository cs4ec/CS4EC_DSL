...
public class WardNurse extends Actor {
  ...
  public class MoveAction_a0a_16 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0a_16(Behaviour behaviour) {
      target = AmberBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0a_6 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_d0a_6(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class UseAction_e0a_2 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public UseAction_e0a_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_f0a_5 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = LabPCRExecutionTimeMap.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class StayAction_d0b_3 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a1.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class Choice_i0d extends InstantBehaviourStep {
    ...
    public void execute() {
      if ((((patient) behaviour.getSignalTrigger().GetData("patient")).FluBInfectionStatus == "Symptomatic") || (((patient) behaviour.getSignalTrigger().GetData("patient")).FluBInfectionStatus == "Asymptomatic")) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0i0d_3(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class SendSignalAction_j0d extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_j0d(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_a0i0d_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0i0d_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_a0i0d_3 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0i0d_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("LabPCRFluBSpecificity"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0i0d_3(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0i0d_5(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Choice_a0i0d_5 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0i0d_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0i0d_3 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0i0d_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0i0d_4 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0i0d_4(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0i0d_5 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0i0d_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0i0d_6 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0i0d_6(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_j0d_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_j0d_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0e_3 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a1_1.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
