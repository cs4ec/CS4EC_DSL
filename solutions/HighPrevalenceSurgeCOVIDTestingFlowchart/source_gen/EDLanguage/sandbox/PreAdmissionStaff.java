...
public class PreAdmissionStaff extends Actor {
  ...
  public class Choice_e0d_1 extends InstantBehaviourStep {
    ...
    public void execute() {
      if ((((patient) behaviour.getSignalTrigger().GetData("patient")).FluAInfectionStatus == "Symptomatic") || (((patient) behaviour.getSignalTrigger().GetData("patient")).FluAInfectionStatus == "Asymptomatic")) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Choice_a0e0d_7(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  ...
  public class StayAction_c0d_3 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = LFD.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class Choice_a0e0d_1 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (Dice(88)) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0e0d_2(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  ...
  public class Choice_a0e0d_7 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0e0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (Dice(95)) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0e0d_7(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new Consequence_a0a0e0d_9(behaviour));
        behaviour.injectSteps(plstSteps);
      }
    }
  }
  public class Choice_a0e0d_9 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_a0e0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0e0d_7 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0e0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0e0d_8 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0e0d_8(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0e0d_9 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0e0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_a0a0e0d_10 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_a0a0e0d_10(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_f0d_3 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_f0d_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitAdmissionTriage_d(Signal s) {
    ...
    plstSteps.add(new Choice_f0d_1(behaviourBuilder));
