...
public class patient extends Actor {
  ...
  public class Choice_a0a0a0 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (Dice(RunEnvironment.getInstance().getParameters().getDouble("InfectionSpreadChance:COVIDSymptomatic-10_a0"))) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public class DecisionTree_a0a extends InstantBehaviourStep {
    ...
    public void execute() {
      ...
      if (patient.this.COVIDInfectionStatus == "Symptomatic" && distanceTo(((patient) behaviour.getSignalTrigger().GetData("patient"))) < 10 && ((patient) behaviour.getSignalTrigger().GetData("patient")).admittedTo == "NA" && !(((isPathObstructed(grid.getLocation(patient.this), grid.getLocation(behaviour.getSignalTrigger().GetData("patient"))))))) {
  ...
  public void ScheduledBehaviourForCOVID() {
    if (deSpawnTime == null) {
      for (Object object : context.getObjects(patient.class)) {
        ...
        if (a != this && a.deSpawnTime == null && distanceTo(a) < 10) {
          Signal s = new Signal();
