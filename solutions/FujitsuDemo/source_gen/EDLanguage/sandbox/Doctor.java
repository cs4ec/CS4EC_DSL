...
public class Doctor extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "AdmittoGreenBayTrigger_b":
        behaviourBuilder = new Behaviour("AdmittoGreenBayTrigger_b", this);
        this.InitAdmitActionAdmittoGreenBay_b(s);
        break;
      case "IspatientbeingadmittedtovulnerableareaTrigger_c":
        behaviourBuilder = new Behaviour("IspatientbeingadmittedtovulnerableareaTrigger_c", this);
        this.InitIspatientbeingadmittedtovulnerablearea_c(s);
        break;
      case "AdmittoVulnerableAreaTrigger_e":
        behaviourBuilder = new Behaviour("AdmittoVulnerableAreaTrigger_e", this);
        this.InitAdmitActionAdmittoVulnerableArea_e(s);
        break;
      case "NoFurtherTestingTrigger_f":
        behaviourBuilder = new Behaviour("NoFurtherTestingTrigger_f", this);
        this.InitDischargeActionNoFurtherTesting_f(s);
        break;
      case "AdmittoCOVIDBayTrigger_g":
        behaviourBuilder = new Behaviour("AdmittoCOVIDBayTrigger_g", this);
        this.InitAdmitActionAdmittoCOVIDBay_g(s);
        break;
      default:
  ...
  public class SendSignalAction_a0h0b extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new NoFurtherTestingTrigger_fSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public void InitAdmitActionAdmittoGreenBay_b(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitIspatientbeingadmittedtovulnerablearea_c(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitAdmitActionAdmittoVulnerableArea_e(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitDischargeActionNoFurtherTesting_f(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitAdmitActionAdmittoCOVIDBay_g(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
