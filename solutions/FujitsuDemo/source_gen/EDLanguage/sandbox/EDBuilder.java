...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    Room StaffOffice_eb = new Room("StaffOffice", context, space, grid, 45, 188, 15, 5, 1, 100, TaskRoom.getInstance(), Color.BLUE, EmergencyDepartment_0);
    Room COVIDCohort_fb = new Room("COVIDCohort", context, space, grid, 40, 165, 10, 10, 1, 10000, COVIDPositiveCohort.getInstance(), Color.RED, EmergencyDepartment_0);
