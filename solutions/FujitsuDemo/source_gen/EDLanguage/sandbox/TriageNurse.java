...
public class TriageNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      ...
      case "PatientArrivesTrigger_i":
        behaviourBuilder = new Behaviour("PatientArrivesTrigger_i", this);
  ...
  public class SendSignalAction_a0h0a extends BehaviourStep {
    ...
    public void execute() {
      ...
      sendSignalTemp = new PerformPCRTrigger_hSignal();
  ...
  public class SendSignalAction_a0i0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new IspatientbeingadmittedtovulnerableareaTrigger_cSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
