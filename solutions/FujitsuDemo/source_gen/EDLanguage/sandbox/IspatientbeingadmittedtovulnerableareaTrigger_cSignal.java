...
public class IspatientbeingadmittedtovulnerableareaTrigger_cSignal extends ActorTypeSignal {
  public IspatientbeingadmittedtovulnerableareaTrigger_cSignal() {
    this.setName("IspatientbeingadmittedtovulnerableareaTrigger_c");
