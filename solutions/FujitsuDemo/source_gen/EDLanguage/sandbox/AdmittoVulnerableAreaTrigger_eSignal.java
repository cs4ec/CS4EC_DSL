...
public class AdmittoVulnerableAreaTrigger_eSignal extends ActorTypeSignal {
  public AdmittoVulnerableAreaTrigger_eSignal() {
    this.setName("AdmittoVulnerableAreaTrigger_e");
