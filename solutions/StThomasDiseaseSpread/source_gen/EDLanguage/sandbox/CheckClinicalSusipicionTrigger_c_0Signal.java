...
public class CheckClinicalSusipicionTrigger_c_0Signal extends ActorTypeSignal {
  public CheckClinicalSusipicionTrigger_c_0Signal() {
    this.setName("CheckClinicalSusipicionTrigger_c_0");
