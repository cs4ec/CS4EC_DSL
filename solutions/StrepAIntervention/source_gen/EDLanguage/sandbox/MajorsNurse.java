...
public class MajorsNurse extends Actor {
  ...
  public class SendSignalAction_a0a4a0_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0a4a0_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0a4a0_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0a4a0_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0b4a0_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0b4a0_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0b4a0_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0b4a0_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class ProbabilityDistribution_e0a_3 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public ProbabilityDistribution_e0a_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      ...
      if (rndDouble < ((50) / 100)) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0a4a0_3(behaviour));
        behaviour.injectSteps(plstSteps);

      } else if (rndDouble < ((50 + 50.0) / 100)) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0b4a0_3(behaviour));
        behaviour.injectSteps(plstSteps);
      }
  ...
  public class ProbabilityDistribution_e0a_5 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public ProbabilityDistribution_e0a_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0b4a2 extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new SenDocReviewTrigger_iSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public void InitWait_b(Signal s) {
    ...
    plstSteps.add(new ProbabilityDistribution_e0a_3(behaviourBuilder));
