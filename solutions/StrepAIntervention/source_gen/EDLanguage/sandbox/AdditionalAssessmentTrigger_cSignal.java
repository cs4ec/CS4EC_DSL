...
public class AdditionalAssessmentTrigger_cSignal extends ActorTypeSignal {
  public AdditionalAssessmentTrigger_cSignal() {
    this.setName("AdditionalAssessmentTrigger_c");
