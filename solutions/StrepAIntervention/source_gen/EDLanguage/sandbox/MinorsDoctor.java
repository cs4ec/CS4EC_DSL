...
public class MinorsDoctor extends Actor {
  ...
  public class SendSignalAction_a0a4a0_7 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0a4a0_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0a4a0_9 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0a4a0_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0b4a0_7 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0b4a0_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0b4a0_9 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0b4a0_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class ProbabilityDistribution_e0a_7 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public ProbabilityDistribution_e0a_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      ...
      if (rndDouble < ((80) / 100)) {
        ...
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0a4a0_7(behaviour));
        behaviour.injectSteps(plstSteps);

      } else if (rndDouble < ((20 + 80.0) / 100)) {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0b4a0_7(behaviour));
        behaviour.injectSteps(plstSteps);
      }

    }
  }
  public class StayAction_f0a_15 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_f0a_15(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class ProbabilityDistribution_e0a_9 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public ProbabilityDistribution_e0a_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_f0a_17 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_f0a_17(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitAssessment_a_0(Signal s) {
    ...
    plstSteps.add(new ProbabilityDistribution_e0a_7(behaviourBuilder));
    plstSteps.add(new StayAction_f0a_15(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);
