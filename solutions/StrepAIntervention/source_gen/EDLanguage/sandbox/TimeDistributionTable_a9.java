...
public class TimeDistributionTable_a9 {
  protected Distribution<Integer> processingTimeDistribution;
  protected static TimeDistributionTable_a9 instance;

  private TimeDistributionTable_a9() {
  ...
  public static TimeDistributionTable_a9 getInstance() {
    if (instance == null) {
      instance = new TimeDistributionTable_a9();
    }
    return instance;
  }
