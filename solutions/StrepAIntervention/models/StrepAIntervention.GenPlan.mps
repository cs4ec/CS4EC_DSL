...
<model ref="r:ac2df552-8ba2-4448-b093-7895f4e0bd3c(StrepAIntervention.GenPlan)">
  ...
  <node concept="2VgMpV" id="5ivS4t6lQT1">
    <property role="TrG5h" value="planOne" />
    <node concept="3uMcMo" id="5ivS4t6lQJa" role="2VgMA7">
      ...
      <node concept="3uMdn$" id="76UJyRV9vMQ" role="3uOsAP">
        <node concept="20RdaH" id="76UJyRV9vMR" role="3uMdmt">
