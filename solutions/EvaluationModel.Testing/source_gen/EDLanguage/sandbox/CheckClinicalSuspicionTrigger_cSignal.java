...
public class CheckClinicalSuspicionTrigger_cSignal extends ActorTypeSignal {
  public CheckClinicalSuspicionTrigger_cSignal() {
    this.setName("CheckClinicalSuspicionTrigger_c");
