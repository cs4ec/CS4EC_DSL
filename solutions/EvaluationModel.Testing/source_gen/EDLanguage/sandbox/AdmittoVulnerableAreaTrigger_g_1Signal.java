...
public class AdmittoVulnerableAreaTrigger_g_1Signal extends ActorTypeSignal {
  public AdmittoVulnerableAreaTrigger_g_1Signal() {
    this.setName("AdmittoVulnerableAreaTrigger_g_1");
