...
public class CheckClinicalSuspicionTrigger_c_1Signal extends ActorTypeSignal {
  public CheckClinicalSuspicionTrigger_c_1Signal() {
    this.setName("CheckClinicalSuspicionTrigger_c_1");
