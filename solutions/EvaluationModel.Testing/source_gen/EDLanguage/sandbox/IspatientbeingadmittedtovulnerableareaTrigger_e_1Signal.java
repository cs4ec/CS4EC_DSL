...
public class IspatientbeingadmittedtovulnerableareaTrigger_e_1Signal extends ActorTypeSignal {
  public IspatientbeingadmittedtovulnerableareaTrigger_e_1Signal() {
    this.setName("IspatientbeingadmittedtovulnerableareaTrigger_e_1");
