...
public class NoFurtherTestingTrigger_h_1Signal extends ActorTypeSignal {
  public NoFurtherTestingTrigger_h_1Signal() {
    this.setName("NoFurtherTestingTrigger_h_1");
