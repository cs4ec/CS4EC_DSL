...
public class NoFurtherTestingTrigger_h_0Signal extends ActorTypeSignal {
  public NoFurtherTestingTrigger_h_0Signal() {
    this.setName("NoFurtherTestingTrigger_h_0");
