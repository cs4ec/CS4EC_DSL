...
public class IspatientbeingadmittedtovulnerableareaTrigger_e_0Signal extends ActorTypeSignal {
  public IspatientbeingadmittedtovulnerableareaTrigger_e_0Signal() {
    this.setName("IspatientbeingadmittedtovulnerableareaTrigger_e_0");
