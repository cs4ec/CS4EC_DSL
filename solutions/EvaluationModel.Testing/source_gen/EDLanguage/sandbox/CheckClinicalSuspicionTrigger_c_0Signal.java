...
public class CheckClinicalSuspicionTrigger_c_0Signal extends ActorTypeSignal {
  public CheckClinicalSuspicionTrigger_c_0Signal() {
    this.setName("CheckClinicalSuspicionTrigger_c_0");
