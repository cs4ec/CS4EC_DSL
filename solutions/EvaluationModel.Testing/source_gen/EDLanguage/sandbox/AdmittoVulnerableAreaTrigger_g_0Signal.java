...
public class AdmittoVulnerableAreaTrigger_g_0Signal extends ActorTypeSignal {
  public AdmittoVulnerableAreaTrigger_g_0Signal() {
    this.setName("AdmittoVulnerableAreaTrigger_g_0");
