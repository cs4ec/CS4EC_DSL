...
public class EDBuilder implements ContextBuilder<Object> {
  ...
  public Context build(Context<Object> context) {
    ...
    // add Locations here 
    Room Room_a = new Room("Room", context, space, grid, 56, 90, 30, 30, 1, 4, DocOffice.getInstance(), Color.RED);
    Room Room2_b = new Room("Room2", context, space, grid, 12, 45, 20, 20, 1, 3, Ward.getInstance(), Color.GREEN);
    try {
      Room_a.setSeats(4);
      Room2_b.setSeats(0);
      Room_a.setDesks(0);
