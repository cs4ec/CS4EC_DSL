...
public class PerformLIATorCepheidTrigger_gSignal extends ActorTypeSignal {
  public PerformLIATorCepheidTrigger_gSignal() {
    this.setName("PerformLIATorCepheidTrigger_g");
