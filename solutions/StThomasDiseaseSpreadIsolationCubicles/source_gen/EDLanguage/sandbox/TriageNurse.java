...
public class TriageNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "CheckSymptomaticTrigger_a":
        behaviourBuilder = new Behaviour("CheckSymptomaticTrigger_a", this);
        this.InitCheckSymptomatic_a(s);
        break;
      case "CheckSymptomaticTrigger_a_0":
        behaviourBuilder = new Behaviour("CheckSymptomaticTrigger_a_0", this);
