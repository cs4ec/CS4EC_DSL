...
public class CheckSymptomaticTrigger_a_0Signal extends ActorTypeSignal {
  public CheckSymptomaticTrigger_a_0Signal() {
    this.setName("CheckSymptomaticTrigger_a_0");
