...
public class CheckClinicalSusipicionTrigger_dSignal extends ActorTypeSignal {
  public CheckClinicalSusipicionTrigger_dSignal() {
    this.setName("CheckClinicalSusipicionTrigger_d");
