...
public class patientGenerator_1 extends AgentGenerator {
  ...
  public Object onGenerate() {
    ...
    if (rndDouble < ((RunEnvironment.getInstance().getParameters().getDouble("COVIDInfectionStatusSusceptible") + 6.0) / 100)) {
      a.COVIDInfectionStatus = "Susceptible";
    }
    if (rndDouble < ((RunEnvironment.getInstance().getParameters().getDouble("COVIDInfectionStatusSymptomatic") + 2.0) / 100)) {
