...
public class Doctor extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "AdmittoWardTrigger_c":
        behaviourBuilder = new Behaviour("AdmittoWardTrigger_c", this);
        this.InitAdmitActionAdmittoWard_b(s);
        break;
  ...
  public class Consequence_e0a extends InstantBehaviourStep {
    ...
    public void execute() {
      ((patient) behaviour.getSignalTrigger().GetData("patient")).admittedTo = "Ward";
  ...
  public class SendSignalAction_b0c extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new AdmittoWardTrigger_cSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public void InitAdmitActionAdmittoWard_b(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
