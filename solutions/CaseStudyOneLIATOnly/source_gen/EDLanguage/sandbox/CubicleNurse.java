...
public class CubicleNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "PerformRapidPCRTrigger_c":
        behaviourBuilder = new Behaviour("PerformRapidPCRTrigger_c", this);
        this.InitPerformRapidPCR_c(s);
        break;
      default:
  ...
  public class SendSignalAction_a0g0a extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new AdmittoSideRoomTrigger_dSignal();
  ...
  public void InitPerformRapidPCR_c(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
