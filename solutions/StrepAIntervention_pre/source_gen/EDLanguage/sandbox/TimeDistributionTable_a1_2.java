...
public class TimeDistributionTable_a1_2 {
  protected Distribution<Integer> processingTimeDistribution;
  protected static TimeDistributionTable_a1_2 instance;

  private TimeDistributionTable_a1_2() {
  ...
  public static TimeDistributionTable_a1_2 getInstance() {
    if (instance == null) {
      instance = new TimeDistributionTable_a1_2();
    }
    return instance;
  }
