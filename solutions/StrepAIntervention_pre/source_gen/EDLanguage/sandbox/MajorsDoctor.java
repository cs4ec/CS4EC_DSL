...
public class MajorsDoctor extends Actor {
    ...
    if (true) {
      if (pRoom.getOccupiers().stream().anyMatch(new Predicate<Agent>() {
        public boolean test(Agent a) {
          return a.getClass() == patient.class && ((Network) context.getProjection("CurrentPatientAllocations")).getEdge(MajorsDoctor.this, a) != null;
        }
      })) {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "TreatmentTrigger_a":
        behaviourBuilder = new Behaviour("TreatmentTrigger_a");
        this.InitTreatment_a(s);
        break;
      ...
      case "DischargeTrigger_f":
        behaviourBuilder = new Behaviour("DischargeTrigger_f");
        this.InitDischargeActionDischarge_f(s);
        break;
      case "TreatmentTrigger_a_1":
        behaviourBuilder = new Behaviour("TreatmentTrigger_a_1");
        this.InitTreatment_a_0(s);
        break;
      case "DischargeTrigger_e_1":
        behaviourBuilder = new Behaviour("DischargeTrigger_e_1");
        this.InitDischargeActionDischarge_e_0(s);
        break;
      case "DischargeTrigger_f_1":
        behaviourBuilder = new Behaviour("DischargeTrigger_f_1");
        this.InitDischargeActionDischarge_f_0(s);
        break;
      default:
  ...
  public class StayAction_d0a extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a0.getInstance().getProcessingTime();
  ...
  public class StayAction_d0d extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a0_1.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class SendSignalAction_a0e0d extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new WaitTrigger_b_1Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_a0f0d extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new AdditionalAssessmentTrigger_c_1Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class DespawnAction_e0e extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0e(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class DespawnAction_e0e_0 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0e_0(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitTreatment_a(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitTreatment_a_0(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitDischargeActionDischarge_e_0(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    ...
    plstSteps.add(new DespawnAction_e0e(behaviourBuilder));
  ...
  public void InitDischargeActionDischarge_f_0(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
