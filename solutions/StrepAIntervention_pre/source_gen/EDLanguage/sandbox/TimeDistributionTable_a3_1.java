...
public class TimeDistributionTable_a3_1 {
  protected Distribution<Integer> processingTimeDistribution;
  protected static TimeDistributionTable_a3_1 instance;

  private TimeDistributionTable_a3_1() {
  ...
  public static TimeDistributionTable_a3_1 getInstance() {
    if (instance == null) {
      instance = new TimeDistributionTable_a3_1();
    }
    return instance;
  }
