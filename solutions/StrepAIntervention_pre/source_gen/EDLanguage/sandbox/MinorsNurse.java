...
public class MinorsNurse extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      ...
      case "WaitTrigger_b_0":
        ...
        this.InitWait_b_1(s);
        break;
      case "WaitTrigger_d_0":
        behaviourBuilder = new Behaviour("WaitTrigger_d_0");
        this.InitWait_d_1(s);
        break;
      case "WaitTrigger_b_2":
        behaviourBuilder = new Behaviour("WaitTrigger_b_2");
        this.InitWait_b_2(s);
        break;
      case "WaitTrigger_d_2":
        behaviourBuilder = new Behaviour("WaitTrigger_d_2");
        this.InitWait_d_2(s);
        break;
      default:
  ...
  public class StayAction_b0a_7 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
  ...
  public class SendSignalAction_c0a_3 extends BehaviourStep {
    ...
    public void execute() {
      ...
      sendSignalTemp = new DischargeTrigger_f_0Signal();
  ...
  public class StayAction_b0b_7 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a3_0.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
    public StayAction_b0b_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_c0b_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_c0b_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new DischargeTrigger_e_0Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class StayAction_b0b_9 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a3_0.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
    public StayAction_b0b_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_c0b_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_c0b_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_b0c_3 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a1_2.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class SendSignalAction_c0c_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_c0c_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new DischargeTrigger_f_2Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_c0c_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_c0c_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class MoveAction_a0d_15 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0d_15(Behaviour behaviour) {
      target = MinorsBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_b0d_3 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a3_2.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
  ...
  public class SendSignalAction_c0d_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_c0d_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new DischargeTrigger_e_2Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));

      b.PushMission(sendSignalTemp);
    }
  }
  public class StayAction_d0d_15 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_d0d_15(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class MoveAction_a0d_17 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0d_17(Behaviour behaviour) {
      target = MinorsBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_c0d_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_c0d_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0d_17 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_d0d_17(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitWait_b_1(Signal s) {
  ...
  public void InitWait_d_1(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0b_11(behaviourBuilder));
    plstSteps.add(new StayAction_b0b_7(behaviourBuilder));
    plstSteps.add(new SendSignalAction_c0b_3(behaviourBuilder));
  ...
  public void InitWait_b_2(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0c_15(behaviourBuilder));
    plstSteps.add(new StayAction_b0c_3(behaviourBuilder));
    plstSteps.add(new SendSignalAction_c0c_3(behaviourBuilder));
    plstSteps.add(new StayAction_d0c_7(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitWait_d_2(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0d_15(behaviourBuilder));
    plstSteps.add(new StayAction_b0d_3(behaviourBuilder));
    plstSteps.add(new SendSignalAction_c0d_3(behaviourBuilder));
    plstSteps.add(new StayAction_d0d_15(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);
