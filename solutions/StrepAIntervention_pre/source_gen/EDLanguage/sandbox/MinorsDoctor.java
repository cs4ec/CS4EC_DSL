...
public class MinorsDoctor extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      case "":
        break;
      case "TreatmentTrigger_a_0":
        behaviourBuilder = new Behaviour("TreatmentTrigger_a_0");
        this.InitTreatment_a_1(s);
        break;
      case "DischargeTrigger_e_0":
        behaviourBuilder = new Behaviour("DischargeTrigger_e_0");
        this.InitDischargeActionDischarge_e_1(s);
        break;
      case "DischargeTrigger_f_0":
        behaviourBuilder = new Behaviour("DischargeTrigger_f_0");
        this.InitDischargeActionDischarge_f_1(s);
        break;
      case "TreatmentTrigger_a_2":
        behaviourBuilder = new Behaviour("TreatmentTrigger_a_2");
        this.InitTreatment_a_2(s);
        break;
      case "DischargeTrigger_e_2":
        behaviourBuilder = new Behaviour("DischargeTrigger_e_2");
        this.InitDischargeActionDischarge_e_2(s);
        break;
      case "DischargeTrigger_f_2":
        behaviourBuilder = new Behaviour("DischargeTrigger_f_2");
        this.InitDischargeActionDischarge_f_2(s);
        break;
      default:
  ...
  public class DespawnAction_e0c_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0c_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_f0c_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_f0c_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class DespawnAction_e0c_2 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0c_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_f0c_2 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_f0c_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class MoveAction_a0d_19 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0d_19(Behaviour behaviour) {
      target = MinorsBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class OrderAction_b0d_11 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public OrderAction_b0d_11(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayForConditionAction_c0d_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public StayForConditionAction_c0d_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0d_19 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a0_2.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
    public StayAction_d0d_19(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_a0e0d_7 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0e0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new WaitTrigger_b_2Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));

      b.PushMission(sendSignalTemp);
    }
  }
  public class SendSignalAction_a0e0d_9 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0e0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_e0d_7 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_e0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).Immunocompromised == "No") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0e0d_7(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class SendSignalAction_a0f0d_7 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0f0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new AdditionalAssessmentTrigger_c_2Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));

      b.PushMission(sendSignalTemp);
    }
  }
  public class SendSignalAction_a0f0d_9 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0f0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_f0d_7 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_f0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).Immunocompromised == "Yes") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0f0d_7(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class StayAction_g0d_7 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_g0d_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class MoveAction_a0d_21 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0d_21(Behaviour behaviour) {
      target = MinorsBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class OrderAction_b0d_13 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public OrderAction_b0d_13(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayForConditionAction_c0d_6 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public StayForConditionAction_c0d_6(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0d_21 extends PassiveBehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int testingTime = TimeDistributionTable_a0_2.getInstance().getProcessingTime();
    /*package*/ int timeExecuted = 0;
    public StayAction_d0d_21(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_e0d_9 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_e0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_f0d_9 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Choice_f0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_g0d_9 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_g0d_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class OrderAction_b0e_7 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public OrderAction_b0e_7(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayForConditionAction_c0e_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public StayForConditionAction_c0e_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_d0e_1 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_d0e_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class DespawnAction_e0e_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0e_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class OrderAction_b0e_9 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public OrderAction_b0e_9(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class StayForConditionAction_c0e_4 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public StayForConditionAction_c0e_4(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Consequence_d0e_2 extends InstantBehaviourStep {
    /*package*/ Behaviour behaviour;
    public Consequence_d0e_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class DespawnAction_e0e_2 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0e_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class DespawnAction_e0f_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0f_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_f0f_1 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_f0f_1(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class DespawnAction_e0f_2 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public DespawnAction_e0f_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class RemoveRelationshipAction_f0f_2 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    public RemoveRelationshipAction_f0f_2(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitTreatment_a_1(Signal s) {
  ...
  public void InitDischargeActionDischarge_e_1(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitDischargeActionDischarge_f_1(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    ...
    plstSteps.add(new DespawnAction_e0c_1(behaviourBuilder));
    plstSteps.add(new RemoveRelationshipAction_f0c_1(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitTreatment_a_2(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0d_19(behaviourBuilder));
    plstSteps.add(new OrderAction_b0d_11(behaviourBuilder));
    plstSteps.add(new StayForConditionAction_c0d_5(behaviourBuilder));
    plstSteps.add(new StayAction_d0d_19(behaviourBuilder));
    plstSteps.add(new Choice_e0d_7(behaviourBuilder));
    plstSteps.add(new Choice_f0d_7(behaviourBuilder));
    plstSteps.add(new StayAction_g0d_7(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);

    Signal sendSignalTemp = new Signal();

  }
  public void InitDischargeActionDischarge_e_2(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0e_7(behaviourBuilder));
    plstSteps.add(new OrderAction_b0e_7(behaviourBuilder));
    plstSteps.add(new StayForConditionAction_c0e_3(behaviourBuilder));
    plstSteps.add(new Consequence_d0e_1(behaviourBuilder));
    plstSteps.add(new DespawnAction_e0e_1(behaviourBuilder));
  ...
  public void InitDischargeActionDischarge_f_2(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    ...
    plstSteps.add(new DespawnAction_e0f_1(behaviourBuilder));
    plstSteps.add(new RemoveRelationshipAction_f0f_1(behaviourBuilder));
    behaviourBuilder.setSteps(plstSteps);
