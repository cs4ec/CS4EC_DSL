...
public class TriageNurse extends Actor {
  ...
  public class SendSignalAction_a0e0d_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0e0d_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new TreatmentTrigger_aSignal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));

      b.PushMission(sendSignalTemp);
    }
  }
  public class SendSignalAction_a0e0d_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0e0d_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_e0d_3 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).Severity == "severe") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0e0d_3(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class SendSignalAction_a0f0d_3 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0f0d_3(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new TreatmentTrigger_a_0Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));

      b.PushMission(sendSignalTemp);
    }
  }
  public class SendSignalAction_a0f0d_5 extends BehaviourStep {
    /*package*/ Behaviour behaviour;

    public SendSignalAction_a0f0d_5(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class Choice_f0d_3 extends InstantBehaviourStep {
    ...
    public void execute() {
      if (((patient) behaviour.getSignalTrigger().GetData("patient")).Severity == "moderate") {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        plstSteps.add(new SendSignalAction_a0f0d_3(behaviour));
        behaviour.injectSteps(plstSteps);
      } else {
        ArrayList<BehaviourStep> plstSteps = new ArrayList();
        behaviour.injectSteps(plstSteps);
  ...
  public class SendSignalAction_a0e0e extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new TreatmentTrigger_a_1Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_a0f0e extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new TreatmentTrigger_a_2Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public void InitChecks_b(Signal s) {
    ...
    plstSteps.add(new Choice_f0d_3(behaviourBuilder));
