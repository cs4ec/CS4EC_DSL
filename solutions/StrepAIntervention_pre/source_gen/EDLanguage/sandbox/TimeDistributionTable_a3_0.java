...
public class TimeDistributionTable_a3_0 {
  protected Distribution<Integer> processingTimeDistribution;
  protected static TimeDistributionTable_a3_0 instance;

  private TimeDistributionTable_a3_0() {
  ...
  public static TimeDistributionTable_a3_0 getInstance() {
    if (instance == null) {
      instance = new TimeDistributionTable_a3_0();
    }
    return instance;
  }
