...
public class TimeDistributionTable_a3_2 {
  protected Distribution<Integer> processingTimeDistribution;
  protected static TimeDistributionTable_a3_2 instance;

  private TimeDistributionTable_a3_2() {
  ...
  public static TimeDistributionTable_a3_2 getInstance() {
    if (instance == null) {
      instance = new TimeDistributionTable_a3_2();
    }
    return instance;
  }
