...
public class SeniorDoc extends Actor {
  ...
  public Behaviour BuildActionFromSignal(Signal s) {
    ...
    switch (s.getName()) {
      ...
      case "AdditionalAssessmentTrigger_c_0":
        ...
        break;
      case "AdditionalAssessmentTrigger_c_1":
        behaviourBuilder = new Behaviour("AdditionalAssessmentTrigger_c_1");
        this.InitAdditionalAssessment_c_1(s);
        break;
      case "AdditionalAssessmentTrigger_c_2":
        behaviourBuilder = new Behaviour("AdditionalAssessmentTrigger_c_2");
        this.InitAdditionalAssessment_c_2(s);
        break;
      default:
  ...
  public class SendSignalAction_e0a_3 extends BehaviourStep {
    ...
    public void execute() {
      ...
      sendSignalTemp = new WaitTrigger_dSignal();
  ...
  public class SendSignalAction_e0b extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new WaitTrigger_d_0Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class SendSignalAction_e0c extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new WaitTrigger_d_1Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class MoveAction_a0d_11 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0d_11(Behaviour behaviour) {
      target = MinorsBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0d_11 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_d0d_11(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public class SendSignalAction_e0d extends BehaviourStep {
    ...
    public void execute() {
      Board b = ReadBoard();
      Signal sendSignalTemp = new Signal();
      sendSignalTemp = new WaitTrigger_d_2Signal();
      sendSignalTemp.AddData("patient", behaviour.getSignalTrigger().GetData("patient"));
  ...
  public class MoveAction_a0d_13 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ Object target;
    /*package*/ Object concreteTarget;
    public MoveAction_a0d_13(Behaviour behaviour) {
      target = MinorsBay.getInstance();
      this.behaviour = behaviour;
    }
  ...
  public class StayAction_d0d_13 extends BehaviourStep {
    /*package*/ Behaviour behaviour;
    /*package*/ int timeExecuted = 0;
    public StayAction_d0d_13(Behaviour behaviour) {
      this.behaviour = behaviour;
    }
  ...
  public void InitAdditionalAssessment_c_1(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
  ...
  public void InitAdditionalAssessment_c_2(Signal s) {
    behaviourBuilder.setSignalTrigger(s);
    ArrayList<BehaviourStep> plstSteps = new ArrayList();
    plstSteps.add(new MoveAction_a0d_11(behaviourBuilder));
    plstSteps.add(new OrderAction_b0d_7(behaviourBuilder));
    plstSteps.add(new StayForConditionAction_c0d_3(behaviourBuilder));
    plstSteps.add(new StayAction_d0d_11(behaviourBuilder));
